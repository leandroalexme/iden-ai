...
function l(e) {
    let t = e || (typeof window < "u" ? window.ServerData ? .config || {} : {}),
        r = typeof window < "u" ? !!window.RM ? .screenshot : !1,
        n = Object.assign({
            ...
            VIDEOS_BACKGROUND_UPLOAD_SIZE_LIMIT: i("constructor.newUploadLimits") ? 200 * 1024 * 1024 : 10 * 1024 * 1024,
            VIDEO_WIDGET_UPLOAD_SIZE_LIMIT: i("constructor.newUploadLimits") ? 200 * 1024 * 1024 : 50 * 1024 * 1024,
            ...
            defaultSidebarTexts: {
                title: "Cart",
                empty\ u0421artTitle: "Cart is empty",
                price: "Price",
                quantity: "Quantity",
                checkout: "Check out"
            },
            ...
            versionHistory: {
                observer: {
                    ...
                    localStorageKey: "rm-version-metadata"
                },
                restore: {
                    pollingInterval: 3 * 1e3
                }
            },
...
var o, S, M, I = s(() => {
    ...
    o = {
        ...
        get: (e, t) => (o.constants === null && (o.constants = l()), o.constants[t])
    }), M = S
});
export {
    R as a, M as b, I as c
};