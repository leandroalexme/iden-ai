...
var P, j, A = C(() => {
    ...
    P = {
        setVideoPosition: function(e) {
            ...
            if (/px/.test(t + o)) t = parseInt(t), o = parseInt(o);
            else {
                if (!e.mag) return;
                let d = e.mag.getContainerSizeCached();
                t = d.width, o = d.height
            }
            let n = e.aspect_poster,
                i = e.aspect_real || n,
                c = e.controls_remove ? 5 : 0,
                u = t + c * 2,
                s = o + c * 2,
                l = u,
                r = s;
            if (n) {
                let d, a;
                u / s > i ? (d = u, a = d / i) : (a = s, d = a * i), n < i ? (l = d, r = l / n) : (r = a, l = r * n)
            }
        ...
        getHighResVideoThumbnail: function(e) {
            ...
            function t(o, n) {
                return o.replace(/(\/)(\w*default)(\.\w+$)/i, "$1" + n + "$3")
            }
        ...
        getEmbedData: async function(e, t, o, n) {
        ...
        getYoutubeIdFromUrl: function(e) {
            ...
            let n = /.*(youtu.*\&v=)([^#\&\?]*).*/;
            return o = e.match(n), o && o[2].length === 11 ? o[2] : null
        },
        ...
        validateVideoFile: async function(e) {
            ...
            let o = await this.probeVideoFile(e);
            if (o) t.metadata = {
                size: e.size,
                duration: Math.floor(o.duration / o.timescale),
                width: o.videoTracks ? .[0] ? .video ? .width,
                height: o.videoTracks ? .[0] ? .video ? .height
            };
            else return t.isValid = !1, t.errorType = "CodecDetectionError", t.errorMessage = "Error detecting video codec", t;
            if (!this.isCodecAllowed(o.videoTracks ? .[0] ? .codec)) return t.isValid = !1, t.errorType = "InvalidCodecError", t.errorMessage = "Please upload a video with H.264 codec", t;
            let {
                video_upload_limit: n
            } = T.getPermissions();
            return e.size > p.VIDEO_WIDGET_UPLOAD_SIZE_LIMIT ? (t.isValid = !1, t.errorType = "TooLargeError", t.errorMessage = `Please upload files smaller than ${E(p.VIDEO_WIDGET_UPLOAD_SIZE_LIMIT)}`, t) : (e.size > n && (t.isValid = !1, t.errorType = "SubscriptionLimitError", t.errorMessage = y("constructor.newUploadLimits") ? "Upgrade your subscription to increase the video file upload limit" : I), t)
        },
        async probeVideoFile(e) {
            return new Promise(async (t, o) => {
                ...
                import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-6I5ZV236.js"), i = n.createFile(), c = new FileReader, u;
                i.onReady = function(r) {
                    u = r
                }, i.onerror = o;
                let s = 0,
                    l = 50 * 1024;
                do try {
                    let r = await new Promise((m, v) => {
                        c.onload = h => {
                            let f = h.target.result;
                            f.fileStart = s, s += f.byteLength, m(f)
                        }, c.onerror = v, c.readAsArrayBuffer(e.slice(s, s + l))
                    });
                    if (r.byteLength) i.appendBuffer(r);
                    else break
                } catch (r) {
                    console.log("error probing video file: ", r), o(r);
                    break
                }
                while (!u);
                t(u)
