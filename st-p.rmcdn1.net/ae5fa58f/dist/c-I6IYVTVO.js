import {
    ...
    k as _,
    l as xt
} from "https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-TVPMZ5RP.js";
import {
    f as H,
    t as W,
    x as mt
...
function Lt({
    ...
    let [Z, j] = (0, s.useState)("prev"), o = (0, s.useMemo)(() => n[a], [n, a]), [tt, I] = (0, s.useState)(!1), [m, it] = (0, s.useState)(!1), f = (0, s.useMemo)(() => n.map((r, l) => r.gallery ? l : null).filter(r => r !== null), [n]), k = n.length > 1 && o.gallery, {
        isImageLoaded: ot,
        preloadImage: et
    } = Bt(), C = ot(o.imgSrc) || tt && m && et(o.imgSrc), P = C ? "zoom-out" : "wait", nt = (0, s.useMemo)(() => o ? .type ? o ? .type === "gif" : /\.gif/.test(o ? .imgSrc), [o ? .imgSrc, o ? .type]), [L, rt] = (0, s.useState)({
    ...
    }(0, s.useEffect)(() => (window.addEventListener("resize", D), t === "viewer" && m && (e ? window.addEventListener("keyup", B) : window.removeEventListener("keyup", B)), () => {
        window.removeEventListener("resize", D), window.removeEventListener("keyup", B)
    }), [e, o, m]);
    let E = (0, s.useMemo)(() => W(o.color), [o]);
    return u($, {
        position: "fixed",
        top: 0,
        left: 0,
