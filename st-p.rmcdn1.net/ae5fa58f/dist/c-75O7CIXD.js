    ...
    let e = new Qo,
        ...
        a = {
            ...
            process: l => {
                ...
                if (n = !0, [e, o] = [o, e], o.clear(), r = e.order.length, r)
                    for (let u = 0; u < r; u++) {
                        let c = e.order[u];
...
function ha(t, e, o, r) {
    let {
        visualElement: n
    } = (0, mt.useContext)(Rt), s = (0, mt.useContext)(qo), i = (0, mt.useContext)(Lt), a = (0, mt.useContext)(Dt).reducedMotion, l = (0, mt.useRef)();
...
var yo, gt, Y, P, Ha, _a, oi, ht = m(() => {
    ...
    yo = t => ({
        ...
        parse: parseFloat,
        transform: e => `${e}${t}`
    }), gt = yo("deg"), Y = yo("%"), P = yo("px"), Ha = yo("vh"), _a = yo("vw"), oi = { ...Y,
...
function sl(t, e, o, r) {
    let n = (0, il.useMemo)(() => {
        ...
        }, Ee(r), t.transformTemplate), { ...s.attrs,
            style: { ...s.style
            }
        }
    }, [e]);
...
var Zl, Jl, kp, Ip, Xl, jp, Np, Z, _t = m(() => {
    "use strict";
    Co();
    jt();
...
var Ke, Gi = m(() => {
    ...
    Ke = class {
        ...
        onKeyframesResolved(e, o) {
            ...
            if (!nc(e, r, n, s))
                if (Ir.current || !i) {
                    l ? .(zt(e, this.options, o)), a ? .(), this.resolveFinishedPromise(), this.updateFinishedPromise();
                    return
...
function Ge({
    ...
    } else if (d === 1) x = y => s - Math.exp(-v * y) * (g + (h + v * g) * y);
    else {
    ...
    fh = {
        ...
        constructor({
            ...
            let {
                ...
                motionValue: n,
                keyframes: s
            } = this.options, i = (a, l) => this.onKeyframesResolved(a, l);
...
function Sh(t, e, o = 0, r = 0, n = 1, s) {
    ...
    return Array.from(t.variantChildren).sort(bh).forEach((u, c) => {
        u.notify("AnimationStart", e), i.push(yn(u, e, { ...s,
            delay: o + l(c)
...
function xn(t, e, o = {}) {
    ...
    if (Array.isArray(e)) {
        ...
        r = Promise.all(n)
    } else if (typeof e == "string") r = yn(t, e, o);
    else {
...
function jc(t) {
    ...
    function i(l) {
        ...
        for (let v = 0; v < Ch; v++) {
            ...
            V === !1 && (d = v);
            let R = y === c[T] && y !== u[T] && b;
            if (R && r && t.manuallyAnimateOnMount && (R = !1), x.protectedKeys = { ...h
            ...
            x.prevProp = y, x.prevResolvedValues = Et, x.isActive && (h = { ...h,
                ...Et
    ...
    Fh = new WeakMap, Mn = class {
        ...
        resolveConstraints() {
            ...
            let {
                dragConstraints: o,
                dragElastic: r
            } = this.getProps(), n = this.visualElement.projection && !this.visualElement.projection.layout ? this.visualElement.projection.measure(!1) : (e = this.visualElement.projection) === null || e === void 0 ? void 0 : e.layout, s = this.constraints;
        ...
        startAnimation(e) {
            ...
            } = this.getProps(), l = this.constraints || {}, u = rt(c => {
        ...
        snapToCursor(e) {
            rt(o => {
                ...
                let {
                    projection: n
                } = this.visualElement, s = this.getAxisMotionValue(o);
                if (n && n.layout) {
                    let {
                        min: i,
                        max: a
...
function Rn(t) {
    let [e, o] = Vu(), r = (0, oo.useContext)(Te);
    return oo.default.createElement(Ds, { ...t,
        layoutGroup: r,
    ...
    return class {
        ...
        startAnimation(i) {
            this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (j(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = C.update(() => {
                to.hasAnimatedSinceResize = !0, this.currentAnimation = Io(0, em, { ...i,
                    onUpdate: a => {
        ...
        getProjectionStyles(i) {
            ...
            if (this.needsReset) return this.needsReset = !1, u.opacity = "", u.pointerEvents = Be(i ? .pointerEvents) || "", u.transform = c ? c(this.latestValues, "") : "none", u;
            let f = this.getLead();
            if (!this.projectionDelta || !this.layout || !f.target) {
                let g = {};
                return this.options.layoutId && (g.opacity = this.latestValues.opacity !== void 0 ? this.latestValues.opacity : 1, g.pointerEvents = Be(i ? .pointerEvents) || ""), this.hasProjected && !wt(this.latestValues) && (g.transform = c ? c({}, "") : "none", this.hasProjected = !1), g
            }
            ...
            for (let g in Se) {
                ...
                let {
                    correct: v,
                    applyTo: T
                } = Se[g], x = u.transform === "none" ? p[g] : v(p[g], f);
                if (T) {
                    let y = T.length;
                    for (let b = 0; b < y; b++) u[T[b]] = x
                } else u[g] = x
            }
            return this.options.layoutId && (u.pointerEvents = f === this ? Be(i ? .pointerEvents) || "" : "none"), u
        }
        clearSnapshot() {
...
var tm, Gh, em, Wh, fe, nd, sm, am, Ns = m(() => {
    "use strict";
    dn();
    ku();
    ju();
...
function gm(t, e, o) {
    ...
    for (let n in e) {
        let s = e[n],
            i = o[n];
        if (E(s)) t.addValue(n, s), le(r) && r.add(n);
        else if (E(i)) t.addValue(n, _(s, {
            owner: t
        })), le(r) && r.remove(n);
        else if (i !== s)
            if (t.hasValue(n)) {
...
var Pm, ad, Tm, ld, Nn, Sm = m(() => {
    ...
    Pm = Object.keys(ee), ad = Pm.length, Tm = ["AnimationStart", "AnimationComplete", "Update", "BeforeLayoutMeasure", "LayoutMeasure", "LayoutAnimationStart", "LayoutAnimationComplete"], ld = ho.length, Nn = class {
        constructor({
            ...
            }, this.initialValues = o.initial ? { ...l
        ...
        getBaseTarget(e) {
            ...
            let {
                initial: n
            } = this.props, s = typeof n == "string" || typeof n == "object" ? (r = Le(this.props, n, (o = this.presenceContext) === null || o === void 0 ? void 0 : o.custom)) === null || r === void 0 ? void 0 : r[e] : void 0;
    ...
    zo = class {
        ...
        attachTimeline(e) {
            let o = this.animations.map(r => {
                if (_m() && r.attachTimeline) r.attachTimeline(e);
                else return r.pause(), Wm(n => {
                    r.time = r.duration * n
                }, e)
            });
            return () => {
...
function pf(t, {
    ...
    return i.forEach((p, h) => {
        for (let d in p) {
            ...
            let y = s.get(h);
            y.keyframes[d] = v, y.transition[d] = { ...e,
                duration: f,
                ease: x,
                times: T,
                ...o
...
function df(t, e, o, r) {
    ...
    for (let a = 0; a < s; a++) {
        ...
        typeof c.delay == "function" && (c.delay = c.delay(a, s)), i.push(...qe(u, { ...e,
            transition: c
        }, {}))
    }
    return new zo(i)
...
function gf(t, e) {
    ...
    return o.forEach(r => {
        let n = _n.get(r);
        n || (n = new Set, _n.set(r, n)), n.add(e), Jt ? .observe(r)
    }), () => {
        o.forEach(r => {
            let n = _n.get(r);
            n ? .delete(e), n ? .size || Jt ? .unobserve(r)
        })
    }
}
var _n, Jt, yf = m(() => {
...
function wf(t, e) {
    let o = {
        ...
        r = t;
    for (; r && r !== e;)
        if (r instanceof HTMLElement) o.x += r.offsetLeft, o.y += r.offsetTop, r = r.offsetParent;
...
function Bf(t, e, o) {
    let {
        ...
        target: n = t,
        axis: s = "y"
    } = o, i = s === "y" ? "height" : "width", a = n !== t ? wf(n, t) : jd, l = n === t ? {
        width: t.scrollWidth,
...
export {
    md as a, dd as b, qs as c, xd as d, vd as e, zd as f, Ed as g, Hd as h, $f as i, _d as j, $d as k
};