    ...
    z = b.extend(D.prototype).extend({
        ...
        render: function() {
            ...
            if (this.makeBox("widget-hotspot"), this.$pinIcons = {
                    default: null,
                    onClick: null
                }, this.rendered = !0, this.phoneTipWrapperTemplate = O["template-common-hotspot-widget-mobile-wrapper"], this.isPreview = !!(RM.constructorRouter && RM.constructorRouter.preview), this.useFreePosition = this.flags ? .tipFreePosition || !1, t = {
                    model: this,
                    $container: this.$el,
                    environment: "viewer",
                    mag: this.page && this.page.mag,
                    block: null
                }, this.hotspotWidget = new I(t), this.$pin = this.$(".pin").addClass("viewer"), this.cursorStyle && this.$pin.css("cursor", this.cursorStyle), this.started && this.renderTip(), this.widget.pinPosRelativeTip === "above" && this.$pin.css("z-index", 3), this.widget.pin_type === "icon") {
        ...
        updateCurrentWidgetData: function() {
            let t = this.page ? .mag ? .viewport || "default",
                e = t !== "default" ? this.currentWidgetData[`viewport_${t}`] : void 0,
                i = e ? { ...this.currentWidgetData,
                    ...e
                } : this.currentWidgetData;
            this.widget = i || this, this.deleteUnusedDataFromContext()
        },
        ...
        renderPinShape: function() {
            let t = new y.default.Model(this);
            t.id = this._id;
        ...
        renderTip: function() {
            ...
            if (!this.isTipRendered) {
                if (this.$tip = (0, h.default)('<div class="tip viewer invisible"></div>'), this.$tip.toggleClass("box-shadow", this["tip_box-shadow"]), this.$tip.css({
                        ...
                        "background-color": $.getRGBA(this["tip_background-color"] || "", (this["tip_background-color-opacity"] ? ? 100) / 100),
                        "border-radius": this["tip_border-radius"]
                        ...
                        border: `${this.widget.tipBorder}px solid ${$.getRGBA(this.widget.tipBorderColor||"",(this.widget.tipBorderOpacity??100)/100)}`,
                        position: "absolute",
                        width: "100%",
                        height: "100%",
                        ...
                        type: "text"
                    }), t !== "default" && (this.pictureData && (this.pictureData = { ...this.pictureData,
                ...
                if (this.blocks = [], this.hasPictureWidget = !!(this.pictureData && !this.pictureData.hidden), this.hasTextWidget = !!(this.textData && !this.textData.hidden), this.hasPictureWidget && (this.pictureData.insideHotspot = !0, this.pictureData.useFreePosition = this.useFreePosition, this.pictureWidget = new U(this.pictureData, this.page, this.$blocksWrapper), this.pictureWidget.isValid() ? (this.pictureData.w = Math.min(this.tip_w, this.pictureData.w), this.blocks.push(this.pictureWidget), this.pictureWidget.render()) : (this.tip_h -= this.pictureWidget.h || 0, this.textData && (this.textData.y = 0), this.pictureWidget = null, this.hasPictureWidget = !1)), this.hasTextWidget && (this.textData.insideHotspot = !0, this.textData.useFreePosition = this.useFreePosition, this.textData.hasGlobalParent = this.is_global, this.textData.version === 3 ? this.textWidget = new B({ ...this.textData,
                    ...
                    }, this.page, this.$blocksWrapper) : this.textWidget = new R(this.textData, this.page, this.$blocksWrapper), this.textWidget.w = Math.min(this.tip_w, this.textWidget.w), this.blocks.push(this.textWidget), this.textWidget.render()), !this.hasPictureWidget && !this.hasTextWidget) {
        ...
        applyTipPosition: function() {
            if (this.useFreePosition) this.hotspotWidget.apply_tip_position({
                ...
                let i = this.calcDistsToPageVisibleBounds(),
                    ...
                    f, C = !1,
                    v = !1;
                d = P(this.tip_pos), w.tip_pos = d, f = this.hotspotWidget.apply_tip_position(w), o = T(d), p.default.each(o, function(l, a) {
                    if (l < 0) switch (a) {
                        case "top":
                            f.top -= l - this.EDGE_GAP, C = !0;
                            break;
                        case "bottom":
                            C || (f.top += l - this.EDGE_GAP);
                            break;
                        case "left":
                            f.left -= l - this.EDGE_GAP, v = !0;
                            break;
                        case "right":
                            v || (f.left += l - this.EDGE_GAP);
                            break
                    }
            ...
            let t = this.is_above ? this.mag.aboveGlobalWidgets : this.page.widgets,
                ...
                s = t.reduce((r, n) => {
                    if (e && n.fixed_position || !e && !n.fixed_position) {
                        let d = n ? .$el && !Number.isNaN(n.$el.css("z-index")) ? n.$el.css("z-index") : -1 / 0;
        ...
        showTip: function() {
            ...
            if (this.isPhone() && (t || !this.useFreePosition)) {
                ...
                let i = W.mapElementToViewport(this.$tip[0], e, 1);
            ...
            this.listenTo(this.page.mag, "change:viewport", this.onMagViewportBeforeChange), this.blocks ? .forEach(e => {
                e ? .$el.on("click", this.onTipLinkClick)
        ...
        hideTip: function() {
            ...
            }.bind(this), 200)) : (this.$tip.addClass("invisible"), this.backToNormalZ(), (0, h.default)("body").off("keydown", this.onBodyKeyDown)), this.stopListening(this.page.mag, "change:viewport"), this.blocks ? .forEach(e => {
                e ? .$el.off("click", this.onTipLinkClick)
            })
        },
        onTipLinkClick: function(t) {
            let e = (0, h.default)(t.currentTarget),
                ...
                s = !!e.find(".close-tip-on-click") ? .length;
            (i || o || s) && this.hideTip()
        },
        ...
        isPhone: function() {
            return _.isMobile() || this.isPreview && this.page.mag.viewport === "phone_portrait"
        },
        isHoverable: function() {
            return this.tip_show_on === "hover" && _.isDesktop() && !this.isPhone() && this.page.mag.viewport !== "tablet_portrait"
        },
