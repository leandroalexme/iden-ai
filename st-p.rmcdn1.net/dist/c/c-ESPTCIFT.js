...
async function r(n, e) {
    ...
    n.startsWith("/api") && (t.headers = { ...t.headers,
        [p.RMVersionHeader]: p.RELEASE
    });
    let s = await fetch(n, t),
        o = s.headers.get("content-type") ? .includes("application/json") ? await s.json() : await s.text();
    if (s.ok) return o; {
        let i = !o || typeof o == "string" ? o : o.message,
            c = o.statusCode || s.status,
            d = {};
        if (typeof o == "object" && o !== null)
            for (let a of Object.keys(o)) a !== "message" && a !== "statusCode" && (d[a] = o[a]);
        throw {
            message: i,
            statusCode: c,
            errorOptions: d
