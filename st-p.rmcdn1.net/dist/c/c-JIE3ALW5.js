                ...
                a.handler = function(p) {
                    if (!(this !== p.target && (/textarea|select/i.test(p.target.nodeName) || p.target.type === "text"))) {
                        ...
                        for (var n = 0, r = m.length; n < r; n++)
                            if (i[m[n]]) return c.apply(this, arguments)
                    }
                }
            }
        }
...
var pt = Y(() => {
    ...
    (function(e) {
        ...
        function D(t, s) {
            var i, n, r, o = t.nodeName.toLowerCase();
        ...
        e.ui = e.ui || {}, e.extend(e.ui, {
            ...
            call: function(t, s, i, n) {
                var r, o = t.plugins[s];
                if (o && (n || t.element[0].parentNode && t.element[0].parentNode.nodeType !== 11))
                    for (r = 0; o.length > r; r++) t.options[o[r][0]] && o[r][1].apply(t.element, i)
            }
        };
        var c = 0,
        ...
        e.cleanData = function(t) {
            ...
            for (var s, i, n = m.call(arguments, 1), r = 0, o = n.length; o > r; r++)
                for (s in n[r]) i = n[r][s], n[r].hasOwnProperty(s) && i !== void 0 && (t[s] = e.isPlainObject(i) ? e.isPlainObject(t[s]) ? e.widget.extend({}, t[s], i) : e.widget.extend({}, i) : i);
            return t
            ...
            _trigger: function(t, s, i) {
                var n, r, o = this.options[t];
                if (i = i || {}, s = e.Event(s), s.type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), s.target = this.element[0], r = s.originalEvent)
                    for (n in r) n in s || (s[n] = r[n]);
            ...
            e.Widget.prototype["_" + t] = function(i, n, r) {
                ...
                var o, d = n ? n === !0 || typeof n == "number" ? s : n.effect || s : t;
            ...
            function() {
                ...
                e.position = {
                        scrollbarWidth: function() {
                            ...
                            var w, f, b = e("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
                                y = b.children()[0];
                    ...
                    function() {
                        var w, f, b, y, C, k = document.getElementsByTagName("body")[0],
                ...
                _getItemsAsjQuery: function(t) {
                    ...
                    if (x && t)
                        for (i = x.length - 1; i >= 0; i--)
                            for (r = e(x[i], this.document[0]), n = r.length - 1; n >= 0; n--) o = e.data(r[n], this.widgetFullName), o && o !== this && !o.options.disabled && g.push([e.isFunction(o.options.items) ? o.options.items.call(o.element) : e(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
                ...
                _removeCurrentsFromItems: function() {
                    ...
                    this.items = e.grep(this.items, function(s) {
                        for (var i = 0; t.length > i; i++)
                            if (t[i] === s.item[0]) return !1;
                        return !0
                    })
                },
                _refreshItems: function(t) {
                    this.items = [], this.containers = [this];
                    var s, i, n, r, o, d, g, x, u = this.items,
                        v = [
                    ...
                    if (M && this.ready)
                        for (s = M.length - 1; s >= 0; s--)
                            for (n = e(M[s], this.document[0]), i = n.length - 1; i >= 0; i--) r = e.data(n[i], this.widgetFullName), r && r !== this && !r.options.disabled && (v.push([e.isFunction(r.options.items) ? r.options.items.call(r.element[0], t, {
                                item: this.currentItem
                            }) : e(r.options.items, r.element), r]), this.containers.push(r));
                    for (s = v.length - 1; s >= 0; s--)
                        for (o = v[s][1], d = v[s][0], i = 0, x = d.length; x > i; i++) g = e(d[i]), g.data(this.widgetName + "-item", o), u.push({
                            item: g,
                            instance: o,
                            width: 0,
                            height: 0,
                ...
                _contactContainers: function(t) {
                    var s, i, n, r, o, d, g, x, u, v, M = null,
                        T = null;
                    ...
                    if (M)
                        if (this.containers.length === 1) this.containers[T].containerCache.over || (this.containers[T]._trigger("over", t, this._uiHash(this)), this.containers[T].containerCache.over = 1);
                        else {
                ...
                _refreshValue: function() {
                    var t, s, i, n, r, o = this.options.range,
                        d = this.options,
                        g = this,
                ...
                _handleEvents: {
                    keydown: function(t) {
                        var s, i, n, r, o = e(t.target).data("ui-slider-handle-index");
                        switch (t.keyCode) {
        ...
        e.effects = {
            ...
            function(t, s) {
                ...
                var o, d = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
                    g = /^([\-+])=\s*(\d+\.?\d*)/,
                    x = [{
                ...
                E.style.cssText = "background-color:rgba(1,1,1,.5)", T.rgba = E.style.backgroundColor.indexOf("rgba") > -1, w(v, function(f, b) {
                    ...
                    var b, y, C = f[0] / 255,
                        ...
                        A = P + H,
                        L = .5 * A;
                    return b = H === P ? 0 : C === P ? 60 * (k - _) / z + 360 : k === P ? 60 * (_ - C) / z + 120 : 60 * (C - k) / z + 240, y = z === 0 ? 0 : .5 >= L ? z / A : z / (2 - A), [Math.round(b) % 360, y, L, S ? ? 1]
                            ...
                            set: function(k, _) {
                                ...
                                if (_ !== "transparent" && (t.type(_) !== "string" || (S = n(_)))) {
                                    if (_ = u(S || _), !T.rgba && _._rgba[3] !== 1) {
                                        for (P = C === "backgroundColor" ? k.parentNode : k;
                                            (H === "" || H === "transparent") && P && P.style;) try {
            ...
            function() {
                function t(r) {
                    var o, d, g = r.ownerDocument.defaultView ? r.ownerDocument.defaultView.getComputedStyle(r, null) : r.currentStyle,
                        x = {};
                    if (g && g.length && g[0] && g[g[0]])
                        for (d = g.length; d--;) o = g[d], typeof g[o] == "string" && (x[e.camelCase(o)] = g[o]);
                    else
                        for (o in g) typeof g[o] == "string" && (x[o] = g[o]);
                    return x
                }
            ...
            function() {
                ...
                var r, o, d, g, x, u, v = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3,
                    M = v,
                    T = e(this),
                    ...
                    C = [];
                for (r = 0; v > r; r++)
                    for (g = f.top + r * y, u = r - (v - 1) / 2, o = 0; M > o; o++) d = f.left + o * b, x = o - (M - 1) / 2, T.clone().appendTo("body").wrap("<div></div>").css({
                        position: "absolute",
                        visibility: "visible",
                        left: -o * b,
                        top: -r * y
...
var gt = Y(() => {
    ...
    (function(e, D) {
        ...
        function p(u, v, M, T, E) {
            ...
            if (k != -1 && !(C.length == 1 && C[0].length == 0)) f = h(C.slice(0, k + 1).join(y), T), s(w, f);
            else {
                var z = u.parent();
                u.detach();
                ...
                hijack: function(l, h, t, s, i) {
                    if (t) {
                        var n = {
                            ...
                            o, d = s || 0,
                            g, x, u, v = isNaN(s) ? t.interactions.length : s;
                        l.type = h, l.originalEvent = null, t.results = [];
                        do
                            if (g = t.interactions[d]) {
    ...
    (function(e) {
        ...
        e.widget("blueimp.fileupload", {
            ...
            _onSend: function(a, c) {
                ...
                var m = this,
                    p, l, h, t, s = m._getAJAXSettings(c),
                    i = function() {
                        return m._sending += 1, s._bitrateTimer = new m._BitrateTimer, p = p || ((l || m._trigger("send", e.Event("send", {
                            ...
                            if (m._onAlways(n, r, o, s), m._sending -= 1, m._active -= 1, s.limitConcurrentUploads && s.limitConcurrentUploads > m._sending)
                                for (var d = m._slots.shift(); d;) {
            ...
            _onAdd: function(a, c) {
                var m = this,
                    ...
                    d, g, x, u, v = 0;
                if (!t) return !1;
                if (i && h[0].size === void 0 && (i = void 0), !(l.singleFileUploads || s || i) || !this._isXHRUpload(l)) x = [h], d = [o];
                else if (!(l.singleFileUploads || i) && s)
                    for (x = [], d = [], u = 0; u < t; u += s) x.push(h.slice(u, u + s)), g = o.slice(u, u + s), g.length || (g = o), d.push(g);
                else if (!l.singleFileUploads && i)
                    for (x = [], d = [], u = 0; u < t; u = u + 1) r += h[u].size + n, (u + 1 === t || r + h[u + 1].size + n > i || s && u + 1 - v >= s) && (x.push(h.slice(v, u + 1)), g = o.slice(v, u + 1), g.length || (g = o), d.push(g), v = u + 1, r = 0);
                else d = o;
...
`).join("");
                    ...
                    if (s > this.options.maxHeight) {
                        if (l.length - this.prevText.length == 1) this.$input.val(this.prevText);
                        else {
...
var xt = Y(() => {
    ...
    (function(e) {
        ...
        if (e.event.fixHooks)
            for (var h = D.length; h;) e.event.fixHooks[D[--h]] = e.event.mouseHooks;
        e.event.special.mousewheel = {
            setup: function() {
                if (this.addEventListener)
                    for (var s = a.length; s;) this.addEventListener(a[--s], t, !1);
                else this.onmousewheel = t
            },
            teardown: function() {
                if (this.removeEventListener)
                    for (var s = a.length; s;) this.removeEventListener(a[--s], t, !1);
            ...
            m.prototype = {
                ...
                onTouchMove: function(h) {
                    ...
                    if (!this.started || i.noActionConstraints && !i.isTargetScrollable) {
                        ...
                        var M = !1;
                        if (this.started && (M = o.up && x.up > r || o.down && x.down > r || o.left && x.left > r || o.right && x.right > r), v >= r)
                            if (this.started = !0, o[u] || M) {
                ...
                onTouchEnd: function(h) {
                    ...
                    if (!this.animating && !(t.length && h.type != "touchcancel") && s) {
                        ...
                        if (!s.noActionConstraints && !s.noActionMovement)
                            if (n[s.curDir] && !n[s.curDir].noTrigger && Math.abs(s.shift) >= i.actionTreshold) {
    ...
    (function(e) {
        e.fn.selectText = function() {
            ...
            if (a = this.eq(0), !!(a && a.is("input"))) {
                if (c = a.get(0), c.setSelectionRange) c.focus(), c.setSelectionRange(D, D);
    ...
    (function(e, D) {
        ...
        function f(I) {
            ...
            for (var F = a.length - 1; F >= 0; F--)
                if (a[F].node !== I.node && a[F].parent.node === I.parent.node) {
                    O = !1;
                    break
                }
        ...
        var a = function() {},
            ...
            m = {
                ...
                transitions: function(_) {
                    ...
                    for (var P in S)
                        if (_.style[S[P]] !== void 0) return !0;
                    return !1
