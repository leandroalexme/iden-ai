...
var E = c.stripe_live ? c.STRIPE_LIVE_PUBLIC_KEY : c.STRIPE_TEST_PUBLIC_KEY,
    K = async () => {
        typeof window < "u" && (k = (await
            import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-JPUTWB27.js")).default)
    },
    k = async (...e) => {
        await K(), k(...e)
    };
...
var ge = U.default.View.extend({
        ...
        toggleSidebar: function(e) {
            if (e) this.hideSidebar(), this.checkoutComplete && (this.checkoutComplete = !1, this.mag.eCommerceCartManager.clearCart(), this.goToInitialTab(), this.hideSuccessPaymentMessage(), this.$paymentFailed.empty(), !this.$successPaymentInMainTab.hasClass("hidden") && this.$successPaymentInMainTab.addClass("hidden"), this.$successPaymentInMainTab.find(".billing-portal-url").empty()), this.clearOrderError();
            else {
        ...
        generateSidebarCSS(e) {
            ...
            this.cardStyle = { ...this.cardStyle,
                ...
                invalid: { ...this.cardStyle.invalid,
                    color: s,
                    fontWeight: e["bar-font-weight"],
                    ":focus": {
                        color: i
    ...
    #cart-sidebar.cart-is-mobile .sidebar-body .cart-item-block {
      background-color: ${d};
        ...
        getAdditionalColor(e) {
            return H(e) < .05 && P("#fff", e) - P("#000", e) >= 8 ? W(.1, e) : B(.1, e)
        },
        ...
        getSidebarTextValue(e) {
            ...
            return this.cartWidgetData && this.cartWidgetData[t] ? _.sanitize(this.cartWidgetData[t]) : c.defaultSidebarTexts[e] ? c.defaultSidebarTexts[e] : null
        },
        calcTextFieldSize(e) {
            if (!e) return null;
        ...
        async goToStripeCheckout() {
            ...
            this.cartWidgetData["stripe-shipping_rates"] ? .length && this.cartWidgetData["stripe-allowed_countries"] ? .length && (t.shippingRates = this.cartWidgetData["stripe-shipping_rates"], t.shippingAddressCollection = {
        ...
        renderShippingForm: async function() {
            ...
            import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-W5EH4HUT.js"), {
                default: s
            } = await
            import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-V6A4TB4W.js"), n = s.extend(r);
        ...
        emailValidation(e, t) {
            return t ? L(t) ? null : "it's not email" : null
        },
        phoneNumberValidation(e, t) {
            return t ? R(t) ? null : "it's not  phone number" : null
        },
        validateShippingForm() {
            let e = !1;
            if (this.mag.eCommerceCartManager.hasShippableProducts())
                for (let t in this.shippingForm) {
        ...
        renderOrderTabForPrices: async function() {
            ...
            if (e && await this.getInvoiceItemsForCustomer(e.id)) {
                ...
                if (i)
                    if (i.created < Math.floor(Date.parse(this.mag.eCommerceCartManager.getCartData().changed) / 1e3)) {
        ...
        renderOrderDetails: async function() {
            ...
            if (e.shipping_methods.length > 1) {
                ...
                import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-V6A4TB4W.js"), o = n.extend(s);
        ...
        onPaymentFormSubmit(e) {
            if (e.preventDefault(), this.cardHolderNameValue) this.$paymentTab.find(".card-name-error").addClass("hidden");
            else {
        ...
        updateCartWidgetData(e = {}) {
            this.cartWidgetData = { ...this.cartWidgetData,
                ...e
            }
        },
        checkShippableInCart: function() {
            let e = this.mag.eCommerceCartManager.getCartData();
            for (let t in e.skus)
                if (e.skus[t].productObject.shippable) return !0;
            return !1
        },
        destroy: function() {
