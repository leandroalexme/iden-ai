    ...
    var O = Object.create,
        ...
        h = (t, e, r, n) => {
            if (e && typeof e == "object" || typeof e == "function")
                for (let s of S(e)) !L.call(t, s) && s !== r && l(t, s, {
                    get: () => e[s],
        ...
        a = class extends u.Component {
            ...
            load(e, r) {
                (0, p.getSDK)(C, N).then(n => {
                    ...
                    }), this.player.bind(m, () => this.props.onEnded()), this.player.bind(f, i => this.props.onError(i))), this.player.load(e, { ...this.props.config.options,
                        callback: () => {
