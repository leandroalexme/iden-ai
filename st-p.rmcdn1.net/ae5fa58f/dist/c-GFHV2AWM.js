...
function x(t) {
    let r = p(),
        i = {
            translatedName: t.nameTranslated ? .[r] || t.name,
            values: [],
            translatedValues: {}
        };
    return t.choices ? .forEach(e => {
        i.values.push(e.text);
        let a = e.textTranslated ? .[r] || e.text;
        i.translatedValues[e.text] = a
    }), i
}

function p() {
    return typeof window < "u" ? window.navigator ? .language ? .substring(0, 2) : "en"
}
...
export {
    _ as a, E as b, u as c, v as d, x as e, p as f, C as g, W as h, A as i, G as j, d as k
};