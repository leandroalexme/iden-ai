...
var H = {
        initialize: function(t) {
            m.default.bindAll(this), m.default.extend(this, t), this.currentData = this._initCurrentData(), window.gtag && this.currentData.userId && !window.RM.common.isDownloadedSource && window.gtag("set", {
                user_id: this.currentData.userId
            }), (0, A.default)(m.default.bind(function() {
                this.initialTracking()
            }, this))
        },
        initialTracking() {
            let t = s("_rm_reg_cookie"),
                e = s("_rm_join_analytics_data");
            this.trackPage(), t && (r("_rm_reg_cookie"), f.sendConversionEvent({
                ...
                eventId: I.Registration
            })), e && r("_rm_join_analytics_data")
        },
        sendEvent: function(t, e) {
            if (!window.gtag || RM.constructorRouter && RM.constructorRouter.previewMode) return;
            let i = {};
            m.default.isObject(e) ? i = m.default.extend(i, e) : i.rm_parameter = e || void 0, window.gtag("event", t, {
                userId: this.currentData.userId,
                campaign: {
                    name: this._rmdata ? .first_campaign,
                    source: this._rmdata ? .first_source,
                    medium: this._rmdata ? .first_medium
                },
                c_id: this.currentData.gacid,
                rm_parameter: i.rm_parameter
            })
        },
        trackPage: function() {
            if (!window.gtag || RM.constructorRouter && RM.constructorRouter.previewMode || E()) return;
            let t = new Date().toISOString().slice(0, 10),
                e = `page_view_last_${this.currentData.userId}`;
            localStorage.getItem(e) !== t && (window.gtag("event", "page_view", {
                userId: this.currentData.userId,
                campaign: {
                    name: this._rmdata ? .first_campaign,
                    source: this._rmdata ? .first_source,
        ...
        _initCurrentData: function() {
            let t = {};
            t.userId = null, window.ServerData.me && (t.userId = window.ServerData.me._id || window.ServerData.me.user && window.ServerData.me.user._id, t.userEmail = window.ServerData.me.email || window.ServerData.me.user && window.ServerData.me.user.email), t.gacid = d.getGAcid();
            let e = s("_rmdata");
            return e && (this._rmdata = JSON.parse(atob(e))), t
        }
    },
    p = H;
var L = {},
...
var V = {
        ...
        setClientIdFromCookie: function() {
            let t = s("_ga");
            if (t) {
                let e = t.match(/GA[0-9]+\.[0-9]+\.(.*)/);
                this.clientId = e.length > 1 ? e[1] : void 0, this.clientId && window.gtag("set", {
        ...
        sendEvent: function(t, e) {
            ...
            if (!RM.common.isDomainViewer) {
                let c = window.ServerData && !window.ServerData.isCountryInEU && window.Cookiebot && !window.Cookiebot.declined,
                    P = window.Cookiebot && (window.Cookiebot.consent.statistics || window.Cookiebot.consented === !1 && window.Cookiebot.declined === !1);
                if (window.ServerData && window.ServerData.isCountryInEU) {
                    if (!P && !RM.common.isDomainViewer) return
                } else if (!c && !RM.common.isDomainViewer) return
            }
            this.setClientIdFromCookie();
            let i = {};
            _.default.isObject(e) ? (i.rm_parameter = e.parameter, i.ecommerceData = e.ecommerceData) : i.rm_parameter = e;
            let O = ["https://readymag.com/websites-of-the-year/", "https://readymag.com/designlayers/"],
                S = RM.common.isProjectOwnedByRM && O.includes(window.location.href);
            if (RM.common.readymagTracker && RM.common.isProjectOwnedByRM && !this.ecommerceEvents.includes(t) || S) {
                let c = {
                    userId: this.userId,
            ...
            if (RM.common.userTracker && !RM.common.homepageRewrite) {
                let c = {
                    rm_parameter: i.rm_parameter,
                    ...i.ecommerceData ? i.ecommerceData : void 0
                };
                window.gtag("event", t, c)
            }
        },
        trackPage: function() {
            window.gtag && (this.setClientIdFromCookie(), RM.common.readymagTracker && RM.common.isProjectOwnedByRM && window.gtag("event", "page_view", {
                ...
                c_id: this.clientId
            }), RM.common.userTracker && window.gtag("event", "page_view"), RM.common.readymagTracker && RM.common.isProjectOwnedByRM && (d.initLinkedInInsights(), d.trackPixelPageView(), d.trackTiktokPixelView()))
        },
        ...
        initialTracking: function() {
            let t = window.ServerData.isCountryInEU;
            M(), t || (this._rmdata = g(), h()), RM.common.isDomainViewer ? this.trackPage() : d.loadLoggedUser(e => {
                window.Cookiebot ? .declined === !1 && (t && h(), e && e._id && (this.userId = e._id, window.gtag && window.gtag("set", {
                    user_id: e._id
                }), window ? .amplitude ? .setUserId(e._id), s("_rm_amp_data") && r("_rm_amp_data")), this.trackPage()), C.waitForCookieConsent().then(i => {
                    if (!i.statistics) {
                        r("_rmdata"), r("_rm_amp_data"), r(a.FIRSTPROMOTER_COOKIE_KEY), r(a.FIRSTPROMOTER_REF_COOKIE_KEY);
                        return
                    }
                    i.marketing && t && (this._rmdata = g())
                })
            })
        }
    },
...
var o = {};
if (typeof window < "u") {
    if (location.origin === a.readymag_auth_host && p ? o = y.default.Model.extend(n.default.extend(n.default.extend(o, p), k)) : R ? o = y.default.Model.extend(n.default.extend(n.default.extend(o, R), k)) : console.error("Analytics initialization error!"), window.RM && window.RM.customAnalyticsHandlers && !n.default.isEmpty(window.RM.customAnalyticsHandlers.event)) {
        let t = o.prototype.sendEvent;
        o.prototype.sendEvent = function() {
            if (!window.ga) return;
            let e = t.apply(this, arguments);
            return window.RM.customAnalyticsHandlers && n.default.isFunction(window.RM.customAnalyticsHandlers.run) && window.RM.customAnalyticsHandlers.run("event", e), e
        }
    }
    if (window.RM && window.RM.customAnalyticsHandlers && !n.default.isEmpty(window.RM.customAnalyticsHandlers.track)) {
        ...
        o.prototype.trackPage = function() {
            if (!window.ga) return;
            let e = t.apply(this, arguments);
            return e && window.RM.customAnalyticsHandlers && n.default.isFunction(window.RM.customAnalyticsHandlers.run) && window.RM.customAnalyticsHandlers.run("track", e), e
        }
    }
}
var it = o;
