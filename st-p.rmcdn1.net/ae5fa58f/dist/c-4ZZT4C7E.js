import {
    a as A
} from "https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-MUXG4K2H.js";
...
var K = V((it, M) => {
    ...
    (function() {
        function o(t, i) {
            document.addEventListener ? t.addEventListener("scroll", i, !1) : t.attachEvent("scroll", i)
        }

        function n(t) {
            document.body ? t() : document.addEventListener ? document.addEventListener("DOMContentLoaded", function i() {
                document.removeEventListener("DOMContentLoaded", i), t()
            }) : document.attachEvent("onreadystatechange", function i() {
                (document.readyState == "interactive" || document.readyState == "complete") && (document.detachEvent("onreadystatechange", i), t())
            })
        }
        ...
        function r(t, i) {
            t.a.style.cssText = "max-width:none;min-width:20px;min-height:20px;display:inline-block;overflow:hidden;position:absolute;width:auto;margin:0;padding:0;top:-999px;white-space:nowrap;font-synthesis:none;font:" + i + ";"
        }

        function d(t) {
            var i = t.a.offsetWidth,
                e = i + 100;
            return t.f.style.width = e + "px", t.c.scrollLeft = e, t.b.scrollLeft = t.b.scrollWidth + 100, t.g !== i ? (t.g = i, !0) : !1
        }

        function z(t, i) {
            function e() {
                var f = C;
                d(f) && f.a.parentNode && i(f.g)
            }
            var C = t;
            o(t.b, e), o(t.c, e), d(t)
        }
        ...
        function g(t, i) {
            return [t.style, t.weight, q() ? t.stretch : "", "100px", i].join(" ")
        }
        y.prototype.load = function(t, i) {
            var e = this,
                C = t || "BESbswy",
                f = 0,
                b = i || 3e3,
            ...
            return new Promise(function(P, O) {
                if (L() && !H()) {
                    var G = new Promise(function(w, x) {
                            function h() {
                                new Date().getTime() - F >= b ? x(Error("" + b + "ms timeout exceeded")) : document.fonts.load(g(e, '"' + e.family + '"'), C).then(function(p) {
                                    1 <= p.length ? w() : setTimeout(h, 25)
                                }, x)
                            }
                            h()
                        }),
                    ...
                    function x() {
                        if (new Date().getTime() - F >= b) c.parentNode && c.parentNode.removeChild(c), O(Error("" + b + "ms timeout exceeded"));
                        else {
                            var s = document.hidden;
                            (s === !0 || s === void 0) && (l = h.a.offsetWidth, u = p.a.offsetWidth, m = I.a.offsetWidth, w()), f = setTimeout(x, 50)
                        }
                    }
                    var h = new a(C),
                        p = new a(C),
                    ...
                    c.dir = "ltr", r(h, g(e, "sans-serif")), r(p, g(e, "serif")), r(I, g(e, "monospace")), c.appendChild(h.a), c.appendChild(p.a), c.appendChild(I.a), document.body.appendChild(c), T = h.a.offsetWidth, j = p.a.offsetWidth, $ = I.a.offsetWidth, x(), z(h, function(s) {
                        l = s, w()
...
var et = A.extend({
        ...
        render: function() {
            let o = !1;
            if (RM.screenshot) window.ServerData.userPermissions && window.ServerData.userPermissions.can_use_e_commerce && (o = !0);
            else {
                let n = U.getPermissions();
                n && n.can_use_e_commerce && (o = !0)
            }
            if (!o) return this.widgetIsLoaded(), this;
            if (A.prototype.render.apply(this, [{
                ...
                let n = this["font-family"];
                n && !N.systemFontsList.includes(n.toLowerCase()) ? new R.default(this["font-family"]).load().then(() => {
        ...
        renderTotalItems: function(o) {
            ...
            let n = 0;
            for (let d in o.skus) o.skus.hasOwnProperty(d) && (n += o.skus[d].cart_count);
            for (let d in o.prices) o.prices.hasOwnProperty(d) && (n += o.prices[d].cart_count);
            let a = n ? `${this.text||""} ${n}` : this.text || "",
        ...
        recalcTextInputSize: function(o) {
            ...
            return this.$textInputSizeAdjuster || (this.$textInputSizeAdjuster = (0, k.default)("<div/>"), this.$textInputSizeAdjuster.css({
                ...
                "font-size": z + "px",
                "letter-spacing": y + "px"
            }), n = this.$textInputSizeAdjuster.width(), a = this.$textInputSizeAdjuster.height(), this.$textInputSizeAdjuster.css("letter-spacing", 0).text("M"), r = this.$textInputSizeAdjuster.width(), r = Math.ceil(r / 2) * 2, d = this.$textInputSizeAdjuster.height(), o.length === 0 && (n = r, a = d), n = Math.ceil(n / 2) * 2, n = n + r, a = Math.ceil(a / 2) * 2, {
                text_w: n,
                text_h: a
            }
        },
