    ...
    l = {
        ...
        isConvexPolygonsIntersects: function(t, e) {
            ...
            for (n = 0; n < t.length; n++)
                if (l.isConvexPolygonContainsPoint(e, t[n])) return !0;
            for (n = 0; n < e.length; n++)
                if (l.isConvexPolygonContainsPoint(t, e[n])) return !0;
            for (n = 0; n < t.length; n++)
                for (i = (n + 1) % t.length, h = 0; h < e.length; h++)
                    if (o = (h + 1) % e.length, l.isLinesIntersects(t[n], t[i], e[h], e[o])) return !0;
            return !1
        },
        ...
        getBoundingBoxOfBoxes: function(t) {
            let e = [],
                n = [];
            for (let h of t) {
                let o = typeof h.right < "u" ? h instanceof DOMRect ? h.toJSON() : { ...h
                } : l.boxToRect(h);
        ...
        getBestPoints: function(t, e) {
            ...
            for (let r = 0; r < n.length; r++)
                for (let g = 0; g < n.length; g++) o = l.getSideCenter(t, n[r]), s = l.getSideCenter(e, n[g]), h = l.getDistance(o, s), i = h < i.distance ? {
                    distance: h,
                    fromSide: n[r],
                    fromPoint: o,
                    toSide: n[g],
        ...
        calculateResizedShapeBox(t, e, {
            ...
            return (e.deltaX > 0 || e.deltaY < 0) && (o = t.left + Math.abs(e.deltaX || e.deltaY) / 2, s = t.top - Math.abs(e.deltaX || e.deltaY) / 2), (e.deltaX < 0 || e.deltaY > 0) && (o = t.left - Math.abs(e.deltaX || e.deltaY) / 2, s = t.top + Math.abs(e.deltaX || e.deltaY) / 2), h !== 0 && h !== 180 ? (r.height = n + e.deltaX, r.width = i + e.deltaY, r.left = o, r.top = s) : (r.height = n + e.deltaY, r.width = i + e.deltaX, r.left = t.left, r.top = t.top), { ...t,
                ...r
            }
        }
    }, B = l
