                                        ...
                                        if (d = E[y], "ks" in d && !d.completed) {
                                            if (d.completed = !0, d.hasMask) {
                                                ...
                                                for (T = z.length, c = 0; c < T; c += 1)
                                                    if (z[c].pt.k.i) u(z[c].pt.k);
                                                    else
                                                        for (W = z[c].pt.k.length, D = 0; D < W; D += 1) z[c].pt.k[D].s && u(z[c].pt.k[D].s[0]), z[c].pt.k[D].e && u(z[c].pt.k[D].e[0])
                                            }
                                    ...
                                    for (F = d - 1; F >= 0; F -= 1)
                                        if (E[F].ty === "sh")
                                            if (E[F].ks.k.i) u(E[F].ks.k);
                                                ...
                                                for (n = E[F].ks.k.length, y = 0; y < n; y += 1) E[F].ks.k[y].s && u(E[F].ks.k[y].s[0]), E[F].ks.k[y].e && u(E[F].ks.k[y].e[0]);
                                    ...
                                    I = function() {
                                        ...
                                        function F(y) {
                                            var n, c = y.length,
                                                T, D;
                                            for (n = 0; n < c; n += 1)
                                                if (y[n].ty === "gr") F(y[n].it);
                                                else if (y[n].ty === "fl" || y[n].ty === "st")
                                                if (y[n].c.k && y[n].c.k[0].i)
                                                    for (D = y[n].c.k.length, T = 0; T < D; T += 1) y[n].c.k[T].s && (y[n].c.k[T].s[0] /= 255, y[n].c.k[T].s[1] /= 255, y[n].c.k[T].s[2] /= 255, y[n].c.k[T].s[3] /= 255), y[n].c.k[T].e && (y[n].c.k[T].e[0] /= 255, y[n].c.k[T].e[1] /= 255, y[n].c.k[T].e[2] /= 255, y[n].c.k[T].e[3] /= 255);
                                            ...
                                            for (n = c - 1; n >= 0; n -= 1)
                                                if (y[n].ty === "sh")
                                                    if (y[n].ks.k.i) y[n].ks.k.c = y[n].closed;
                                                        ...
                                                        for (D = y[n].ks.k.length, T = 0; T < D; T += 1) y[n].ks.k[T].s && (y[n].ks.k[T].s[0].c = y[n].closed), y[n].ks.k[T].e && (y[n].ks.k[T].e[0].c = y[n].closed);
                                            ...
                                            for (c = 0; c < T; c += 1) {
                                                if (n = y[c], n.hasMask) {
                                                    ...
                                                    for (W = X.length, D = 0; D < W; D += 1)
                                                        if (X[D].pt.k.i) X[D].pt.k.c = X[D].cl;
                                                        else
                                                            for (J = X[D].pt.k.length, z = 0; z < J; z += 1) X[D].pt.k[z].s && (X[D].pt.k[z].s[0].c = X[D].cl), X[D].pt.k[z].e && (X[D].pt.k[z].e[0].c = X[D].cl)
                                                }
                                                n.ty === 4 && F(n.shapes)
                                            }
                                        }
...
`), i = {}, r, a = 0, h = 0; h < s.length; h += 1) r = s[h].split(":"), r.length === 2 && (i[r[0]] = r[1].trim(), a += 1);
            ...
            function Pi() {
                ...
                function o(f, A) {
                    ...
                    for (var u = k[g] > p ? -1 : 1, v = !0; v;)
                        if (k[g] <= p && k[g + 1] > p ? (l = (p - k[g]) / (k[g + 1] - k[g]), v = !1) : g += u, g < 0 || g >= S - 1) {
                            if (g === S - 1) return x[g];
                            v = !1
                        }
                ...
                if (o.to) {
                    ...
                    if (t >= g || t < p) {
                        ...
                        var M = u.segmentLength * A,
                            C, w = e.lastFrame < t && e._lastKeyframeIndex === a ? e._lastAddedLength : 0;
            ...
            function we(t) {
                ...
                if (this.propType === "unidimensional") e = t * this.mult, Ps(this.v - e) > 1e-5 && (this.v = e, this._mdf = !0);
                    ...
                    for (var s = 0, i = this.v.length; s < i;) e = t[s] * this.mult, Ps(this.v[s] - e) > 1e-5 && (this.v[s] = e, this._mdf = !0), s += 1
            }
            ...
            var nt = function() {
                ...
                function s(r) {
                    var a = i.newElement(),
                        h, m = r._length === void 0 ? r.v.length : r._length;
            ...
            var te = function() {
                ...
                Ie = function() {
                    ...
                    function e(g, p, l) {
                        var u = l.lastIndex,
                            v, M, C, w, I, N, O, V, j, E = this.keyframes;
                        ...
                        for (N = p._length, O = v.i[0].length, l.lastIndex = u, w = 0; w < N; w += 1)
                            for (I = 0; I < O; I += 1) j = C ? v.i[w][I] : v.i[w][I] + (M.i[w][I] - v.i[w][I]) * V, p.i[w][I] = j, j = C ? v.o[w][I] : v.o[w][I] + (M.o[w][I] - v.o[w][I]) * V, p.o[w][I] = j, j = C ? v.v[w][I] : v.v[w][I] + (M.v[w][I] - v.v[w][I]) * V, p.v[w][I] = j
                    }
                    ...
                    function r(g, p) {
                        ...
                        var l, u = g._length;
                        for (l = 0; l < u; l += 1)
                            if (g.v[l][0] !== p.v[l][0] || g.v[l][1] !== p.v[l][1] || g.o[l][0] !== p.o[l][0] || g.o[l][1] !== p.o[l][1] || g.i[l][0] !== p.i[l][0] || g.i[l][1] !== p.i[l][1]) return !1;
                        return !0
                    }
            ...
            Y([yt], bt), bt.prototype.initModifierProperties = function(t, e) {
                ...
                var a, h, m = this.shapes.length,
                    o, b, _, P, f, A = 0;
                if (s === e)
                    for (h = 0; h < m; h += 1) this.shapes[h].localShapeCollection.releaseShapes(), this.shapes[h].shape._mdf = !0, this.shapes[h].shape.paths = this.shapes[h].localShapeCollection, this._mdf && (this.shapes[h].pathsData.length = 0);
                else if (s === 1 && e === 0 || s === 0 && e === 1) {
                    if (this._mdf)
                        for (h = 0; h < m; h += 1) this.shapes[h].pathsData.length = 0, this.shapes[h].shape._mdf = !0
                } else {
                    var x = [],
                        k, S;
                    for (h = 0; h < m; h += 1)
                        if (k = this.shapes[h], !k.shape._mdf && !this._mdf && !t && this.m !== 2) k.shape.paths = k.localShapeCollection;
                        else {
                ...
                for (s ? (P = s._length, k = s._length) : (s = nt.newElement(), P = 0, k = 0), x.push(s), a = 0; a < h; a += 1) {
                    for (f = i[a].lengths, s.c = r[a].c, o = r[a].c ? f.length : f.length + 1, m = 1; m < o; m += 1)
                        if (_ = f[m - 1], b + _.addedLength < e.s) b += _.addedLength, s.c = !1;
                        else if (b > e.e) {
                        s.c = !1;
                        break
                ...
                if (h !== 0) {
                    ...
                    for (s = 0; s < i; s += 1) {
                        if (m = this.shapes[s], o = m.localShapeCollection, !(!m.shape._mdf && !this._mdf && !t))
                            for (o.releaseShapes(), m.shape._mdf = !0, e = m.shape.paths.shapes, a = m.shape.paths._length, r = 0; r < a; r += 1) o.addShape(this.processPath(e[r], h));
                ...
                if (this._mdf || t) {
                    ...
                    for (var l, u; a;) {
                        if (e = this.elemsData[i].it, s = e[e.length - 1].transform.mProps.v.props, u = s.length, e[e.length - 1].transform.mProps._mdf = !0, e[e.length - 1].transform.op._mdf = !0, e[e.length - 1].transform.op.v = this._currentCopies === 1 ? this.so.v : this.so.v + (this.eo.v - this.so.v) * (i / (this._currentCopies - 1)), p !== 0) {
                            ...
                            for (this.matrix.reset(), l = 0; l < u; l += 1) s[l] = this.matrix.props[l];
                        p += 1, a -= 1, i += r
                    }
                } else
                ...
                if (h !== 0) {
                    ...
                    for (s = 0; s < i; s += 1) {
                        if (b = this.shapes[s], _ = b.localShapeCollection, !(!b.shape._mdf && !this._mdf && !t))
                            for (_.releaseShapes(), b.shape._mdf = !0, e = b.shape.paths.shapes, a = b.shape.paths._length, r = 0; r < a; r += 1) _.addShape(this.processPath(e[r], h, m, o));
            ...
            Y([yt], ge), ge.prototype.initModifierProperties = function(t, e) {
                ...
                if (!t.c)
                    for (h = a - 1; h >= 0; h -= 1) o = G.shapeSegmentInverted(t, h), b.push(Bs(o, e));
                b = Ui(b);
                var _ = null,
                    P = null;
                ...
                if (h !== 0) {
                    ...
                    for (s = 0; s < i; s += 1) {
                        if (b = this.shapes[s], _ = b.localShapeCollection, !(!b.shape._mdf && !this._mdf && !t))
                            for (_.releaseShapes(), b.shape._mdf = !0, e = b.shape.paths.shapes, a = b.shape.paths._length, r = 0; r < a; r += 1) _.addShape(this.processPath(e[r], h, o, m));
                        b.shape.paths = b.localShapeCollection
                    }
                }
                this.dynamicProperties.length || (this._mdf = !1)
            ...
            function Ht(t, e, s) {
                ...
                var h, m = this.masksProperties,
                    ...
                    p = "clip-path";
                for (r = 0; r < a; r += 1)
                    if ((m[r].mode !== "a" && m[r].mode !== "n" || m[r].inv || m[r].o.k !== 100 || m[r].o.x) && (g = "mask", p = "mask"), (m[r].mode === "s" || m[r].mode === "i") && o === 0 ? (A = q("rect"), A.setAttribute("fill", "#ffffff"), A.setAttribute("width", this.element.comp.data.w || 0), A.setAttribute("height", this.element.comp.data.h || 0), b.push(A)) : A = null, h = q("path"), m[r].mode === "n") this.viewData[r] = {
            ...
            var si = function(t, e, s, i) {
                    ...
                    var r = t.o,
                        a = t.i,
                        h = t.v,
                        m, o = " M" + i.applyToPointStringified(h[0][0], h[0][1]);
                ...
                oa = function() {
                    ...
                    function h(P, f, A) {
                        var x, k, S, g, p, l, u = f.styles.length,
                            v = f.lvl,
                            M, C, w, I;
                        for (l = 0; l < u; l += 1) {
                            if (g = f.sh._mdf || A, f.styles[l].lvl < v) {
                                ...
                                if (g)
                                    for (w = v - f.styles[l].lvl, I = f.transformers.length - 1; w > 0;) C.multiply(f.transformers[I].mProps.v), w -= 1, I -= 1
                            } else C = t;
                ...
                for (o = b; o >= 0; o -= 1) {
                    if (S = this.searchProcessedElement(t[o]), S ? e[o] = s[S - 1] : t[o]._render = h, t[o].ty === "fl" || t[o].ty === "st" || t[o].ty === "gf" || t[o].ty === "gs" || t[o].ty === "no") S ? e[o].style.closed = !1 : e[o] = this.createStyleElement(t[o], r), t[o]._render && e[o].style.pElem.parentNode !== i && i.appendChild(e[o].style.pElem), f.push(e[o].style);
                        ...
                        if (!S) e[o] = this.createGroupElement(t[o]);
                            ...
                            for (P = e[o].it.length, _ = 0; _ < P; _ += 1) e[o].prevViewData[_] = e[o].it[_];
            ...
            lt.prototype.defaultBoxWidth = [0, 0], lt.prototype.copyData = function(t, e) {
                ...
                var M = t.tr / 1e3 * t.finalSize,
                    C;
                if (t.sz)
                    for (var w = !0, I = t.sz[0], N = t.sz[1], O, V; w;) {
                ...
                var E = 0,
                    F;
                for (r = 0; r < a; r += 1)
                    if (h = !1, F = t.finalText[r], C = F.charCodeAt(0), C === 13 || C === 3 ? (E = 0, A.push(x), k = x > k ? x : k, x = -2 * M, o = "", h = !0, f += 1) : o = F, e.chars ? (l = e.getCharData(F, p.fStyle, e.getFontByName(t.f).fFamily), u = h ? 0 : l.w * t.finalSize / 100) : u = e.measureText(o, t.f, t.finalSize), F === " " ? E += u + M : (x += u + M + E, E = 0), i.push({
                            l: u,
                            an: u,
                            add: _,
                            n: h,
                ...
                for (S = 0; S < g; S += 1) {
                    ...
                    var W = -1,
                        z;
                    if (y.s.rn === 1)
                        for (r = 0; r < a; r += 1) n = i[r], W != n.anIndexes[S] && (W = n.anIndexes[S], z = D.splice(Math.floor(Math.random() * D.length), 1)[0]), n.anIndexes[S] = z
                }
            ...
            Qt.prototype.searchProperties = function() {
                ...
                if (this.lettersChangedFlag = e, !(!this._mdf && !this._isFirstFrame && !e && (!this._hasMaskedPath || !this._pathData.m._mdf))) {
                    ...
                    if (this._hasMaskedPath) {
                        ...
                        if (A = this._pathData.pi, x = this._pathData.f.v, l = 0, p = 1, S = 0, g = !0, M = A.segments, x < 0 && O.v.c)
                            for (A.tLength < Math.abs(x) && (x = -Math.abs(x) % A.tLength), l = M.length - 1, v = M[l].points, p = v.length - 1; x < 0;) x += v[p].partialLength, p -= 1, p < 0 && (l -= 1, v = M[l].points, p = v.length - 1);
                        ...
                        if (a.reset(), mt = 1, f[_].n) o = 0, b += t.yOffset, b += F ? 1 : 0, x = $, F = !1, this._hasMaskedPath && (l = K, p = ut, v = M[l].points, u = v[p - 1], k = v[p], C = k.partialLength, S = 0), St = "", Et = "", wt = "", It = "", Ft = this.defaultPropsArray;
                            ...
                            for (n = 0; n < c; n += 1) {
                                if (d = i[n].a, y = i[n].s, D = y.getMult(f[_].anIndexes[n], r.a[n].s.totalChars), d.sk.propType && (D.length ? a.skewFromAxis(-d.sk.v * D[0], d.sa.v * D[1]) : a.skewFromAxis(-d.sk.v * D, d.sa.v * D)), d.r.propType && (D.length ? a.rotateZ(-d.r.v * D[2]) : a.rotateZ(-d.r.v * D)), d.ry.propType && (D.length ? a.rotateY(d.ry.v * D[1]) : a.rotateY(d.ry.v * D)), d.rx.propType && (D.length ? a.rotateX(d.rx.v * D[0]) : a.rotateX(d.rx.v * D)), d.o.propType && (D.length ? mt += (d.o.v * D[0] - mt) * D[0] : mt += (d.o.v * D - mt) * D), t.strokeWidthAnim && d.sw.propType && (D.length ? gt += d.sw.v * D[0] : gt += d.sw.v * D), t.strokeColorAnim && d.sc.propType)
                                    for (R = 0; R < 3; R += 1) D.length ? rt[R] += (d.sc.v[R] - rt[R]) * D[0] : rt[R] += (d.sc.v[R] - rt[R]) * D;
                                if (t.fillColorAnim && t.fc) {
                                    if (d.fc.propType)
                                        for (R = 0; R < 3; R += 1) D.length ? Z[R] += (d.fc.v[R] - Z[R]) * D[0] : Z[R] += (d.fc.v[R] - Z[R]) * D;
