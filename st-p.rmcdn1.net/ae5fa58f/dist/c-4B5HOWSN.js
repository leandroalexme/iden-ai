...
var a, m, u, i = n(() => {
  ...
  ${l({primary:{color:o.red,"&:hover, &:focus":{color:o.black}},secondary:{color:o.black,"&:hover, &:focus":{color:o.red,"& path":{fill:o.red}}},tertiary:{color:o.gray,"&:hover, &:focus":{color:o.red,"& path":{fill:o.red}}},bordered:{color:o.black,"&:hover, &:focus":{color:o.red,"& svg":{color:o.red},"& path":{fill:o.red}},border:`
        1 px solid $ {
            e(.92, o.black)
        }
        `,borderRadius:"8px","&:disabled":{opacity:"1 !important",color:`
        $ {
            e(.6, o.black)
        }
        `,border:`
        ...
        `}},unstyled:{},clean:{"&:hover,&:focus":{opacity:.8}}})}
`);
    a.defaultProps = {
        textStyle: "regular",
        variant: "secondary",
