import {
    a as Qt
} from "https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-GJV32VR4.js";
import {
    a as jt
} from "https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-GNQTUJTH.js";
import {
    a as L,
    b as Vt,
    c as Oe,
...
import {
    c as Yt,
    e as Ni
} from "https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-7LJYPHQU.js";
import {
    a as Xt
} from "https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-7QWQSLOT.js";
import {
    d as O,
    e as et
...
import {
    ...
    b as Zt,
    d as Kt
} from "https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-3RJH5757.js";
import {
    a as Dt,
    b as Ii,
    c as Ft,
...
window.Modernizr = function(e, t, i) {
    var o = "2.8.3",
        ...
        le = [],
        R = le.slice,
        ee, X = function(l, d, b, f) {
            var z, D, re, me, te = t.createElement("div"),
                ve = t.body,
                H = ve || t.createElement("body");
            if (parseInt(b, 10))
                for (; b--;) re = t.createElement("div"), re.id = f ? f[b] : a + (b + 1), te.appendChild(re);
            return z = ["&#173;", '<style id="s', a, '">', l, "</style>"].join(""), te.id = a, (ve ? te : H).innerHTML += z, H.appendChild(te), ve || (H.style.background = "", H.style.overflow = "hidden", me = s.style.overflow, s.style.overflow = "hidden", s.appendChild(H)), D = d(te, l), ve ? te.parentNode.removeChild(te) : (H.parentNode.removeChild(H), s.style.overflow = me), !!D
        },
        ce = function(l) {
            var d = e.matchMedia || e.msMatchMedia;
            if (d) return d(l) && d(l).matches || !1;
            var b;
            return X("@media " + l + " { #" + a + " { position: absolute; } }", function(f) {
        ...
        de = function() {
            ...
            function d(b, f) {
                ...
                var z = b in f;
                return z || (f.setAttribute || (f = t.createElement("div")), f.setAttribute && f.removeAttribute && (f.setAttribute(b, ""), z = Q(f[b], "function"), Q(f[b], "undefined") || (f[b] = i), f.removeAttribute(b))), f = null, z
            }
            return d
        }(),
        ue = {}.hasOwnProperty,
        he;
    !Q(ue, "undefined") && !Q(ue.call, "undefined") ? he = function(l, d) {
        return ue.call(l, d)
    } : he = function(l, d) {
        return d in l && Q(l.constructor.prototype[d], "undefined")
    ...
    function Ye(l, d, b) {
        for (var f in l) {
            var z = d[l[f]];
            if (z !== i) return b === !1 ? l[f] : Q(z, "function") ? z.bind(b || d) : z
        }
        return !1
    }
    ...
    function E(l, d, b) {
        var f = l.charAt(0).toUpperCase() + l.slice(1),
            z = (l + " " + G.join(f + " ") + f).split(" ");
        return Q(d, "string") || Q(d, "undefined") ? Ae(z, d) : (z = (l + " " + x.join(f + " ") + f).split(" "), Ye(z, d, b))
    }
    h.flexbox = function() {
        return E("flexWrap")
        ...
        return !!(r.canvas && Q(t.createElement("canvas").getContext("2d").fillText, "function"))
    }, h.webgl = function() {
        return !!e.WebGLRenderingContext
    }, h.touch = function() {
        var l;
        return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? l = !0 : X(["@media (", P.join("touch-enabled),("), a, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(d) {
            l = d.offsetTop === 9
        }), l
        ...
        return j("background-color:rgba(150,255,150,.5)"), we(c.backgroundColor, "rgba")
    }, h.hsla = function() {
        return j("background-color:hsla(120,40%,100%,.5)"), we(c.backgroundColor, "rgba") || we(c.backgroundColor, "hsla")
    }, h.multiplebgs = function() {
        return j("background:url(https://),url(https://),red url(https://)"), /(url\s*\(.*?){3}/.test(c.background)
        ...
        return j((l + "-webkit- ".split(" ").join(d + l) + P.join(b + l)).slice(0, -l.length)), we(c.backgroundImage, "gradient")
        ...
        var l = !!E("perspective");
        return l && "webkitPerspective" in s.style && X("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(d, b) {
        ...
        var l;
        return X('@font-face {font-family:"font";src:url("https://")}', function(d, b) {
        ...
        var l;
        return X(["#", a, "{font:0/0 a}#", a, ':after{content:"', v, '";visibility:hidden;font:3px/1 a}'].join(""), function(d) {
            l = d.offsetHeight >= 3
        }), l
    }, h.video = function() {
    ...
    for (var Se in h) he(h, Se) && (ee = Se.toLowerCase(), r[ee] = h[Se](), le.push((r[ee] ? "" : "no-") + ee));
    r.input || Xe(), r.addTest = function(l, d) {
        if (typeof l == "object")
    ...
    return function(l, d) {
        ...
        (function() {
            try {
                ...
                y.innerHTML = "<xyz></xyz>", re = "hidden" in y, H = y.childNodes.length == 1 || function() {
                    d.createElement("a");
        ...
        function bi(y, k) {
            var W = y.createElement("p"),
                N = y.getElementsByTagName("head")[0] || y.documentElement;
            return W.innerHTML = "x<style>" + k + "</style>", N.insertBefore(W.lastChild, N.firstChild)
        }
        ...
        function je(y) {
            var k = ve[y[me]];
            return k || (k = {}, te++, y[me] = te, ve[te] = k), k
        }

        function dt(y, k, W) {
            if (k || (k = d), H) return k.createElement(y);
            W || (W = je(k));
            var N;
            return W.cache[y] ? N = W.cache[y].cloneNode() : D.test(y) ? N = (W.cache[y] = W.createElem(y)).cloneNode() : N = W.createElem(y), N.canHaveChildren && !z.test(y) && !N.tagUrn ? W.frag.appendChild(N) : N
        }

        function fi(y, k) {
            if (y || (y = d), H) return y.createDocumentFragment();
            k = k || je(y);
            for (var W = k.frag.cloneNode(), N = 0, mt = ct(), xi = mt.length; N < xi; N++) W.createElement(mt[N]);
            return W
        }
        ...
        function vi(y, k) {
            k.cache || (k.cache = {}, k.createElem = y.createElement, k.createFrag = y.createDocumentFragment, k.frag = k.createFrag()), y.createElement = function(W) {
                return Me.shivMethods ? dt(W, y, k) : k.createElem(W)
            }, y.createDocumentFragment = Function("h,f", "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + ct().join().replace(/[\w\-]+/g, function(W) {
        ...
        function ht(y) {
            y || (y = d);
            var k = je(y);
            return Me.shivCSS && !re && !k.hasCSS && (k.hasCSS = !!bi(y, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), H || vi(y, k), y
        }
        var Me = {
            ...
            shivDocument: ht,
            createElement: dt,
            createDocumentFragment: fi
        };
        l.html5 = Me, ht(d)
    }(e, e.document), r._version = o, r._prefixes = P, r._domPrefixes = x, r._cssomPrefixes = G, r.mq = ce, r.hasEvent = de, r.testProp = function(l) {
        return Ae([l])
    }, r.testAllProps = E, r.testStyles = X, r.prefixed = function(l, d, b) {
...
(function() {
    Modernizr.addTest("retina", function() {
        ...
        if (/ Safari\//.test(navigator.userAgent) && !/ Chrom/.test(navigator.userAgent)) {
            let e = navigator.userAgent.match(/ Version\/(\d+)/) ? ? [];
...
function Ui(e) {
    return new Promise(t => {
        switch (e) {
            case "addtocart":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-GHW5DU3F.js"));
                break;
            case "audio":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-DG7G46NJ.js"));
                break;
            case "background":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-JVWKIQ5Y.js"));
                break;
            case "button":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-LSCGMQS2.js"));
                break;
            case "ecommercecart":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-4ZZT4C7E.js"));
                break;
            case "facebook":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-FC2UTDP3.js"));
                break;
            case "form":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-TX3WT2SU.js"));
                break;
            case "picture":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-BC7YZXWG.js"));
                break;
            case "gmaps":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-BSLUZ5GL.js"));
                break;
            case "hotspot":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-5DOYHFMS.js"));
                break;
            case "iframe":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-OHP6OXFE.js"));
                break;
            case "shape":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-UYCQ54W6.js"));
                break;
            case "slideshow":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-I43RVJLS.js"));
                break;
            case "text":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-DWLORVAY.js"));
                break;
            case "twitter":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-M46IBQPH.js"));
                break;
            case "video":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-ZUUZRPLH.js"));
                break;
            case "rmfooter":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-DTCMMDIQ.js"));
                break;
            case "rmheader":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-EXAGD3AG.js"));
                break;
            case "shots":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-XKIFD5HI.js"));
                break;
            case "lottie":
                t(
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-QYFSDX6L.js"));
                break;
            default:
                break
        }
...
async function co(e = []) {
    let i = (e ? .length ? e : Object.values(Qe)).map(o => Ui(o).then(r => {
        fe[o] = r.default
    }));
...
De();
be();
var Yi = ot.default.View.extend({
        initialize: function(e) {
            A.default.bindAll(this), A.default.extend(this, e);
            let t = {};
            A.default.each(this.widgets, A.default.bind(function(o) {
                if (o.hasAnimation()) {
                    let r = o.fixed_position || o.is_full_width || o.is_full_height || o.sticked ? _.generateUUID() : O.getUuidHash(o.getAnimations()) || _.generateUUID();
                    t[r] = t[r] || [], t[r].push(o)
                }
        ...
        addAnimation: function(e, t) {
            ...
            [...e[0].getAnimations()].map(r => O.isMoveOnly(r) ? { ...r,
                effects: "moveOnly"
            } : O.isNonMove(r) ? { ...r,
                effects: "nonMove"
        ...
        onResize: function(e) {
            if (e = e || {}, e.updateAll || this.isFixed && this.prevPageScale !== this.page.scale || this.isFullwidth || this.isFullheight || this.isSticked) {
                let t = {
                    ...
                    i;
                this.isFixed || this.isFullwidth || this.isFullheight || this.isSticked ? this.bbox_css = { ...this.widgets[0].calcBoxStyle({
                        calcBBox: !0
                    }).dimensions,
                    ...this.isNested ? {
                        left: 0,
            ...
            O.isOffsetPathEnabled(this.animation ? .steps) && this.timeline && this.timeline.createOffsetPath(this.getCenterPoint()), this.innerContentTop = this.page.contentPosition.top / this.page.scale, this.innerContainerHeight = this.page.mag.getContainerSizeCached().height / this.page.scale, this.prevPageScale = this.page.scale
        },
...
Ee.load = se.extend({
    ...
    isReady: function() {
        let e;
        if (RM.screenshot || this.started || _.PageVisibilityManager.isPageHidden()) e = window.Promise.reject();
        else {
...
Ee.click = se.extend({
    ...
    initialize: function() {
        se.prototype.initialize.apply(this, arguments);
        let e = "pointer";
        this.page ? .mag ? .opts.useCustomCursor && this.page ? .mag ? .opts.customHoverCursorImage && (e = _.getCursorStylesString({
...
function ti({
    ...
    function c(x) {
        n.cursorPosition = {
            x: ei(x) ? x.touches[0].clientX : x.clientX,
            y: ei(x) ? x.touches[0].clientY : x.clientY
        }
    }
        ...
        for (let h of e)
            ...
            oe.querySelectorAll("[data-shadow-interactions]").forEach(R => {
                ...
                if (ue || de) {
                    ...
                    X && h.fixed_position && (J.y = J.y - n.scrollTop + n.pageTop);
                    let b = de ? d ? Se : "ffffff00" : Se,
                        f = ue ? Je({
                            blur: Q,
                            rect: J,
                            angleData: h.angle ? r[h._id] : void 0,
                    ...
                    if (z) {
                        let D = R;
                        D.style.textShadow = z, D.style.transition = de ? `text-shadow ${Xe}s` : n.renderState.canUseTransition ? "text-shadow .1s" : ""
                    }
                }
            })
        }
    ...
    function M() {
        return e.filter(x => typeof x.angle < "u").reduce((x, C) => (x[C._id] = At(C.angle), x), {})
    }

    function P() {
        return e.some(x => x.shadow ? !0 : Ot(x) && x.styles ? x.styles.some(C => C.inlineStyles ? .keys ? .includes("SHADOW")) : !1)
    }
    ...
    function G() {
        return t ? .mag ? .viewOpts && t ? .mag ? .viewOpts.viewertype || "vertical"
    }
    return a(), p(window.pageYOffset), {
        start() {
            n.isDestroyed || !P() || (window.addEventListener(o, c), window.addEventListener("resize", a), G() === "vertical" ? B.listenTo(t.mag, "mag_scroll", p) : B.listenTo(t, "page_scroll", p), s())
        },
        stop() {
            window.cancelAnimationFrame(n.rafId), window.removeEventListener(o, c), window.removeEventListener("resize", a), G() === "vertical" ? B.stopListening(t.mag, "mag_scroll", p) : B.stopListening(t, "page_scroll", p)
        },
        destroy() {
...
var ii = { ...Jt,
    ...
    st = nt.default.View.extend({
        template: ii["template-viewer-page"],
        widgetsFetched: !1,
        ...
        render: function() {
            if (this.setElement(this.template({
                ...
                let e = this.getPageViewport(),
                    t = RM.screenshot && Ce("pdf") === "true";
                this.$el.css({
                    overflow: "hidden",
                    height: this[`viewport_${e}`] ? .height || Math.max(this.height, 672),
                    width: t ? this.mag.getViewportWidth("default") : this[`viewport_${e}`] ? .width || V.dictionary[e].width,
                    position: "relative"
                }), Ce("pdf") === "true" && (this.$fixedPositionContainer.css({
                    height: "100%"
        ...
        async show() {
            if (!this.shown) {
                ...
                if (this.viewerType === "horizontal" && this.onResize(), !this.widgets && !this.widgetsFetched && (!RM.screenshotMode || RM.screenshotMode === "published")) return this.whenWidgetsFetched = this.whenWidgetsFetched || new Promise(e => {
                    this.widgetFetchController = typeof AbortController < "u" ? new AbortController : void 0, Ft(this.mag.num_id, this._id, this.widgetFetchController ? .signal).then(t => {
        ...
        start: function(e) {
            ...
            }), this.focusPage(), this.$scrollWrapper.addClass("accelerated-scroll"), this.animations && this.animations.start(), this.shadowInteractions ? .start(), this.mag.aboveGlobalAnimations && this.mag.aboveGlobalAnimations.start(), this.lightboxModel || this.createLightbox(), this
        },
        stop: function(e) {
            ...
            }), this.animations && this.animations.stop(), this.mag.aboveGlobalAnimations && this.mag.aboveGlobalAnimations.stop(), this.shadowInteractions ? .stop(), this
        },
        getUrl: function() {
        ...
        scrollOnVerticalMode: function(e) {
            ...
            let t, i, o, r = this.pageHeight - this.pageBgHeight;
            ...
            }), this.trigger("page_scroll", this.getScroll()), this.trigger("page_scroll_unlim", this.getScroll(!0)), !this.isStickyVerticalViewer && (this.$el.css("top", 0), _.applyTransform(this.$el, t ? "translateY(" + t + "px) translateZ(0)" : ""), this.hasFixedWidgets ? (this.$contentBounds.css({
                top: i
            }), _.applyTransform(this.$contentBounds, "")) : (this.$contentBounds.css({
                top: ""
            }), _.applyTransform(this.$contentBounds, i ? "translateY(" + i + "px)" : "")))
        },
        resetScrollOnVerticalMode: function() {
            this.hasScrollOnVerticalMode && (this.hasScrollOnVerticalMode = !1, this.visibleWidgetsCoords = this.visibleWidgetsCoords || {}, this.visibleWidgetsCoords.scrollTop = 0, this.visibleWidgetsCoords.scrollTopUnlim = 0, this.animations && this.animations.onScroll({
                forceApply: !this.isStickyVerticalViewer
            }), !this.isStickyVerticalViewer && (this.$el.css("top", ""), _.applyTransform(this.$el, ""), this.hasFixedWidgets ? this.$contentBounds.css("top", 0) : _.applyTransform(this.$contentBounds, "")))
        },
        hide: function() {
            return this.shown && (this.$el.addClass("hidden"), this.widgetFetchController ? .abort(), this.whenWidgetsFetched = void 0, this.shown = !1), this
        },
        destroyAllWidgets: function(e) {
            ...
            }.bind(this)), this.animations && this.animations.destroy(), this.shadowInteractions ? .destroy(), delete this.animations, clearTimeout(this.fireReadyTimeout)
        },
        destroy: function() {
        ...
        getWidgetsPacks: function() {
            ...
            if (this.BGWidget && !this.BGWidget.rendered && !this.BGWidget.loaded && a.push(this.BGWidget), this.fixedWidgets && this.fixedWidgets.length) {
                let T;
                for (n = 0; n < this.fixedWidgets.length; n++) T = this.fixedWidgets[n], !T.rendered && !T.loaded && !T.canRenderImmediately() && a.push(T)
            }
            let p = [],
                c = 99999,
                w = -99999,
                v, M = !1,
                P;
            for (n = 0; n < this.widgets.length; n++) s = this.widgets[n], !s.rendered && !s.loaded && s.type != "background" && !s.fixed_position && (P = st.getScreenIndex(s, t, o, !0), v = P.index, c = Math.min(P.start, c), w = Math.max(P.end, w), s.screenIndex = v, v !== 1 / 0 && (p[v] = p[v] || [], p[v].push(s)), M = !0);
            if (M) {
        ...
        loadForScreenshotMode: function() {
            S.default.each(this.widgets, async e => {
                try {
                    await e.render(), e.start()
                } catch (t) {
                    e.widgetIsLoaded(), console.error(`WidgetRenderError Failed to render widget ${e._id} for a screenshot. Type: ${e.type} Page: ${this._id} Project: ${this.mag.num_id}`, t.stack ? .toString ? .() || t.toString ? .() || t)
                }
            })
        },
        createWidgetsForCurrentViewport: function() {
            ...
            S.default.each(this.widgetsData, function(c) {
                ...
                !fe[w.type] || w.hidden || v || (!w.fixed_position && w.z && w.type !== "background" && (o = Math.min(o, w.z)), i.push(w))
                ...
                let M = null;
                if (this.widgets && this.widgets.length && (M = this.widgets.find(function(G) {
                        return G ? G._id === c._id : !1
                    })), !fe[c.type]) return;
                let T = M || new fe[c.type](c, r);
                T.type === "video" && (T.updateWidgetData(c, r), T.applyBoxStyle(), T ? .updateVideoWidget(c)), T.type === "background" && (n.BGWidget = T, n.hasVideoBG = T.hasVideoBG()), T.isValid() && (T.fixed_position && n.fixedWidgets.push(T), t.push(T))
            }.bind(this)), this.widgets = wt(t, "_id"), this.widgets = Ie(this.widgets);
            let s = I.isOn(e, this.mag.getViewportWidth(e), this.mag.viewOpts) && I.isCSSTransform();
            this.animations = new Ge({
                page: this,
                widgets: this.widgets
            }), this.shadowInteractions = ti({
                page: this,
        ...
        getWidgetViewportData: function(e, t) {
            ...
            if (t !== "default" && e["viewport_" + t]) {
                let s = !_.canUseMinimalViewport(this.mag) && Lt(e),
                    a = s ? Rt(e) : !1,
                    p = Ze(e.type, e.version, !1);
                S.default.each(p, c => {
                    if (!(e.type === "shape" && (c === "borders" || c === "weight" || c === "bg_color")) && !(e.type === "background" && c === "picture") && !(e.type === "text" && e.version === 3 && c === "blocks")) {
                        if (s && (o[c] = void 0), L.isGlobalKey(c)) {
                            let w = L.getGlobalPrefixedKey(c);
                            o[w] = void 0
                        }
                        s && ft("viewer.brokenLegacyWidget") ? o[c] = a && !S.default.has(e["viewport_" + t], c) && r.includes(c) ? e[c] : void 0 : s && (o[c] = e.type === "button" && !S.default.has(e["viewport_" + t], c) && n.includes(c) ? e[c] : void 0)
                    }
        ...
        signalOnLoading: function() {
            ...
            }, this), this.BGWidget && this.hasVideoBG && this.BGWidget.on("videoBGStarted", n, this.BGWidget), i == 0 && (this.fireReadyTimeout = setTimeout(s, 200));

            function r() {
                i--, clearTimeout(o[this._id]), this.type == "background" && t.destroyLQBackground({
                    animate: !0
                }), this.hasLoadAnimation() && (t._widgetsWithLoadAnimation--, t._widgetsWithLoadAnimation || (t.loadAnimationsReady = !0, t.trigger("loadAnimationsReady"))), i || (t.fireReadyTimeout = setTimeout(s, 200)), t.trigger("loaded" + this._id)
            }

            function n() {
                t.videoBGStarted = !0, S.default.delay(function() {
                    t.trigger("videoBGStarted")
                }, 1300)
            }

            function s() {
                t.loaded = !0, t.trigger("pageLoaded")
            }
        },
        ...
        waitForAnimationEnd: function(e) {
            this.resetWaitHook = _.waitForTransitionEnd(this.$el, this.mag.getPageTransitionTime() + 1e3, "transform", e)
        },
        ...
        focusPage: function() {
            u.isDesktop() && this.viewerType !== "vertical" && (_.isIframe() || this.$el[0].getBoundingClientRect().left === 0 && (this.$content.focus(), this.mag.$el.scrollTop(0)))
        },
        markAsLast: function() {
        ...
        scrollPageALittle: function() {
            this.$scrollWrapper.animate({
                scrollTop: (0, ke.default)(window).height() / 2
            }, 500)
        },
        ...
        onResize: function(e) {
            ...
            if (I.isOn(this.pageViewport, r, this.mag.opts) && I.isCSSZoom() && !t && (G.zoom = s, G.left = o.width > this.mag.opts.scalewidth ? (o.width / s - n) / 2 : (r - n) / 2), this.$content.removeAttr("style"), this.$content.css(G), this.cachedSizes = void 0, this.contentPosition = {
                    left: T,
                    top: P
                }, !t && I.normalize(s, "transform", this.pageViewport, r, this.mag.viewOpts) === 1 ? _.applyTransform(this.$content, "") : (_.applyTransform(this.$content, "scale(" + p.scale + ")"), RM.screenshot && I.isCSSTransform() && this.$content.css({
                ...
                let x = this.animations.animations ? .filter(C => st.findPlayingVideo(C.widgets));
        ...
        showPagePasswordForm: async function() {
            ...
            import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-SCLTZMYX.js");
        ...
        createLQBackground: function() {
            ...
            if (this.LQBG)
                if (t.selectedType === "picture" && this.LQBG.selectedType === "picture" && t.picture && this.LQBG.picture && t.picture.poorUrl === this.LQBG.picture.poorUrl || t.selectedType === "video" && this.LQBG.selectedType === "video" && t.video && this.LQBG.video && t.video.thumbnail_url === this.LQBG.video.thumbnail_url) {
            ...
            if (this.$fixedBgContainer.css("background-color", "#" + t.color), t.picture && t.selectedType === "picture" && (t.picture.poorUrl || Ne.useLambdaUrl(t.picture)) || t.video && t.selectedType === "video" && t.video.thumbnail_url) {
                ...
                let i = ii["template-viewer-widget-background"];
                if (this.LQBG.$el = (0, ke.default)(i({
                        data: t
                    ...
                    Ne.useLqipUrl(t.picture) && (o = Ne.getLqipUrl(this.LQBG.picture), this.LQBG.$el.addClass("lqip").appendTo(this.$fixedBgContainer)), (0, ke.default)("<img/>").on("load", S.default.bind(function() {
        ...
        resizeLQBackground: function() {
            RM.screenshot || this.isPasswordProtected() || !this.LQBG || this.LQBG.selectedType === "video" && Nt.setVideoPosition({
                mag: this.mag,
        ...
        getLightboxWidgets() {
            return this.lightboxWidgets = Gt(this.widgets), this.lightboxWidgets
        },
        async createLightbox() {
            if (this.widgetsData ? .some(t => {
                    if (t.type === "picture") {
                        let o = !!t.lightbox;
                ...
                import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-HYRG7ENT.js");
                this.lightboxModel = new nt.default.Model({
                    isVisible: !1,
                    ...
                    onClose: () => {
                        this.lightboxModel.set({
                            isVisible: !1
                        }), this.mag.navigation ? .show(!0), this.mag.navigation ? .enable()
                    },
                    onSlideChange: o => this.lightboxModel.set({
                        index: o
                    })
                }), (0, ke.default)("<div/>").addClass("lightbox-wrapper").appendTo(this.$el), Fe({
                    component: () => rt.default.createPortal(Tt(t, {}), document.body),
                    domElement: this.$el.find(".lightbox-wrapper").get(0),
                    model: this.lightboxModel,
                    onDestroy: () => {
                        let o = this.$el.find(".lightbox-wrapper").get(0);
                        rt.default.unmountComponentAtNode(o), o && o.parentNode && o.parentNode.removeChild(o)
                    }
                })
            }
        },
        showLightboxSlide(e) {
            this.mag.navigation ? .hide(!0), this.mag.navigation ? .disable();
...
$e();
Be();
var ji = ni.default.View.extend({
        ARROWS_SHOW_DELAY: 1e3,
        BOTTOM_SHOW_DELAY: 1e3,
        BOTTOM_HIDE_DELAY: 0,
        template: ri["template-viewer-navigation"],
        events: {
        ...
        initialize: function(e) {
            return Y.default.bindAll(this), Y.default.extend(this, e), this.updateScaleState.__debounced = Y.default.debounce(this.updateScaleState, 100), this.canSwitchPages = !0, this
        },
        render: function() {
            ...
            })), this.$el.appendTo(this.$container), this.$prev = this.$(".navigation-arrow.left"), this.$next = this.$(".navigation-arrow.right"), this.$bottom = this.$(".navigation-arrow.bottom"), Y.default.delay(Y.default.bind(function() {
                this.$prev.removeClass("offscreen"), this.$next.removeClass("offscreen")
            }, this), this.ARROWS_SHOW_DELAY), this.setArrowsPosition(this.mag.currentPage), this.listenTo(this.mag, "pageChanged", this.setArrowsPosition), this.listenTo(this.mag, "keypress-" + Pe.default.keycodes.left, this.goPrevPage), this.listenTo(this.mag, "keypress-" + Pe.default.keycodes.right, this.goNextPage), u.isDesktop() && (0, Pe.default)(window).bind("mousewheel", this.onMouseWheel), u.isDesktop() || ((0, Pe.default)(window).bind("gesturechange", this.updateScaleState.__debounced), this.updateScaleState(), this.mag.getPagesCount() > 1 && this.setSwipeAction()), this
        },
        destroy: function() {
            return u.isDesktop() && (0, Pe.default)(window).unbind("mousewheel", this.onMouseWheel), u.isDesktop() || ((0, Pe.default)(window).unbind("gesturechange", this.updateScaleState.__debounced), this.pagesSwipe && this.pagesSwipe.destroy()), this.remove()
        },
        ...
        setSwipeAction: function() {
            this.pagesSwipe = this.mag.$mag_container.RMSwipe({
                ...
                getMaxTransitionSpeed: Y.default.bind(function() {
                    return this.mag.getPageTransitionTime()
                }, this),
                customMoveCheck: Y.default.bind(function(e, t) {
                    return !(e.hasClass("prev-page") && t < 0 || e.hasClass("next-page") && t > 0)
                }, this),
                beforeAutoAnimation: Y.default.bind(function(e) {
                    return this.mag.showPageCounter(e), {
                        autoAnimate: !0,
                        immediateCallback: !1
                    }
                }, this),
                onSwipeStart: Y.default.bind(function() {
                    this.mag.showPageCounter()
                }, this),
                getCurrentConstraints: Y.default.bind(function(e) {
                    let t = {},
                ...
                callback: Y.default.bind(function(e) {
        ...
        recalcBottomArrowState: function(e) {
            ...
            let t = e ? .isBottomArrowVisible();
            this.viewerType === "horizontal" && I.isScaleLayout(this.mag.viewOpts) && (t = !1), this.isPreview && this.mag.viewport !== "default" && (t = !1), this.bottomArrowTimeout = setTimeout(Y.default.bind(function() {
        ...
        updateScaleState: function() {
            Modernizr.android || this.$prev.add(this.$next).add(this.$bottom).toggleClass("scaled-offscreen", _.isPageNativelyScaled())
        },
        hide: function(e = !1) {
...
be();
$e();
var Qi = pi.default.View.extend({
        template: ai["template-viewer-share"],
        events: {
        ...
        getEmbedCode: function(e) {
            let t, i, o, r, n = U.EMBED_SCRIPT_INIT,
...
Le();
Ci();
var qi = di.default.View.extend({
        template: ci["template-viewer-mag-menu"],
        events: {
        ...
        initialize: function(e) {
            ...
            } = zt(t, r), this.loadVisibleScreenshots.__debounced = pe.default.debounce(this.loadVisibleScreenshots, 500), this.unloadInvisibleScreenshots.__debounced = pe.default.debounce(this.unloadInvisibleScreenshots, 3e3), this
        },
        render: function() {
            let e = this.mag.viewport;
            ...
            if (this.viewerType == "horizontal" ? (this.$(".pages").css("width", t.length * this.PAGE_WIDTH), this.$pagesWrapper.scrollLeft(99999)) : (this.$(".pages").css("height", t.length * this.PAGE_HEIGHT), this.$pagesWrapper.scrollTop(99999)), u.isDesktop() && (this.scroll = this.$(".scroll-wrapper").RMScroll({
                    ...
                    dragScroll: !0,
                    tp: this.viewerType
                }).data("scroll")), this.$pagesWrapper.bind("scroll", this.onScroll), this.cacheSize(), this.cacheScroll(), this.cachePagesPos(), this.loadedScreenshots = {}, this.showInitially && (this.loadVisibleScreenshots(), this.show(!0)), this.viewerType == "horizontal" && u.isMobile() || (0, F.default)(".menu-info .mag-title").dotdotdot({
        ...
        show: function(e = !1) {
            return this.shown || (this.shown = !0, e && this.$el.css({
                transition: "none"
            }), this.mag.$el.addClass("viewer-mag-menu-shown"), (0, F.default)("html").addClass("mag-menu-shown"), this.mag.$el.toggleClass("viewer-mag-menu-no-project-info", !this.hasProjectInfo), this.loadOtherScreenshots(), this.mag.trigger("menuShown"), B.trigger("magMenu:open"), e && setTimeout(() => this.$el.css({
                transition: ""
            }))), this
        },
        toggle: function() {
        ...
        hide: function() {
            return this.shown && (this.mag.$el.removeClass("viewer-mag-menu-shown viewer-mag-menu-no-project-info"), (0, F.default)("html").removeClass("mag-menu-shown"), this.clearLoadOtherTimeout(), this.mag.focusCurrentPage(), this.shown = !1, this.mag.trigger("menuHidden"), B.trigger("magMenu:close")), this
        },
        destroy: function() {
            return (0, F.default)(window).off("resize", this.onResize), (0, F.default)("html").removeClass("mag-menu-shown"), this.$el.unbind("mousewheel", this.onMouseWheel), this.menuSwipe && this.menuSwipe.destroy(), this.$pagesWrapper.unbind("scroll", this.onScroll), this.hide(), this.remove()
        },
        ...
        shiftToPage: function(e, t) {
            let i = this.cachedData.scrollSize,
                ...
                a = o + i - r / 2,
                p;
            if (this.setActivePage(e), n < s) p = n - s;
        ...
        onPageClick: function(e) {
            ...
            let t = (0, F.default)(e.currentTarget).data("num");
        ...
        onConstructorScreenshotRenew(e, t, i) {
            let o = this.$(".page").filter(function() {
                    return (0, F.default)(this).data("id") === e
                }),
...
be();
$e();
var Zi = mi.default.View.extend({
        PAGE_COUNTER_TIMEOUT: 2800,
        PAGE_COUNTER_TIMEOUT_INITIAL: 4e3,
        brandingInToolbar: !1,
        template: si["template-viewer-toolbar"],
        events: {
        ...
        render: function() {
            if (this.setElement(this.template({
                ...
                })), this.$el.appendTo(this.$container), this.$menuButton = this.$el.find(".menu-button"), this.$shareButton = this.$el.find(".share-button"), this.$pageCounter = this.$el.find(".page-counter"), this.$pageCounterWrapper = this.$pageCounter.parent(), this.hasShare && (this.share = new li({
                    mag: this.mag,
                    router: this.router,
                ...
                e.each(function(o, r) {
                    setTimeout(function() {
                        (0, pt.default)(r).removeClass("offscreen-initially")
                    }, i), i -= t
                })
            }
        ...
        renderMagMenu() {
            this.magMenu && this.magMenu.destroy(), this.magMenu = new hi({
                mag: this.mag,
                pages: this.pages,
                router: this.router,
                isPreview: this.isPreview,
        ...
        toggleShare: function(e) {
            (0, pt.default)(e.target).is(this.$shareButton) && this.share && this.share.toggle()
        },
        ...
        changeProjectInfoVisible(e = !0) {
            this.hasProjectInfo !== e && (this.hasProjectInfo = e, this.magMenu ? .showProjectInfo(e))
        },
...
function ui() {
    ...
    function o(r) {
        t.isTouchEvent = Ki(r), t.cursorPosition = {
...
var Ji = lt.default.View.extend({
        ...
        SCROLL_SNAP: 0,
        template: oi["template-viewer-mag"],
        ...
        initialize: function(e, t) {
            ...
            let i = !1;
            if (e.hasSummary) this.staticGlobalWidgetsData = e.globalWidgets || [], this.aboveGlobalWidgetsData = e.aboveAllWidgets || [];
            else {
            ...
            e.pages.forEach(s => void(s.pagePath = s.pagePath || s.uri || s.num.toString())), e.pages.forEach(s => void(s.uri = s.pagePath)), e.pages.forEach(s => {
                if (s.wids.length && typeof s.wids[0] == "string") s.wids = s.wids.filter(a => !o.includes(a) && !r.includes(a)).concat(r), s.widgetsData = [...this.staticGlobalWidgetsData];
                else {
            ...
            }), g.default.extend(this, e), this.hasWidgetsWithVerticalOnscrollAnimation = i || e.hasWidgetsWithVerticalOnscrollAnimation, this.hasTextWidgetsV3 = e.hasTextWidgetsV3, this.model = new Ct(e, {
                parse: !0
            }), this.router = t;
            let n = s => {
            ...
            return this.eCommerceManager = new We({
                ...
                isPublished: this.router.environment === U.environment.viewer,
                isDownloadedSource: window.RM.common.isDownloadedSource,
                onDataChange: n
            }), this.eCommerceManager.setCartWidgetExistState(Et(this.router.environment, [...this.staticGlobalWidgetsData, ...this.aboveGlobalWidgetsData])), this.eCommerceCartManager = new Yt({
                router: this.router,
                mag: this,
        ...
        getViewportOptions(e = "default") {
            ...
            return { ...this.model.get("opts"),
                ...e !== "default" ? this.model.get(t) ? .opts || {} : {}
            }
        },
        setViewerOptions(e) {
            if (this.viewport = e, typeof window < "u" && typeof window.Proxy < "u") {
                    ...
                    get(i, o) {
                        ...
                        if (t.viewport !== "default") {
                            let n = `viewport_${t.viewport}`,
                                s = t.getProjectOptions(t.model.get(n) ? .opts, t.viewport, !1)[o];
                ...
                this.viewOpts = { ...this.getProjectOptions(this.model.get("opts"), this.viewport, !0),
                    ...this.viewport !== "default" ? this.getProjectOptions(this.model.get(t) ? .opts, this.viewport, !1) : {}
                }
            }
        ...
        getCursorCssStylesString({
            ...
            if (!e) return "";
            let r = `cursor: ${this.getCursorCssString({cursorUrl:e,isHover:o})}`;
            if (i && t) {
    ...
    -webkit-image-set(
      ...
      `,
        ...
        unsetViewerClasses: function() {
            if (this.$el.removeClass("viewer-type-horizontal viewer-type-vertical").removeClass("pages-pos-normal pages-pos-overlap viewer-type-vertical-sticky"), (0, m.default)("html").removeClass("overflow-on-vertical-view controls-on-top"), this.$magScrollSizer ? .css("height", ""), (0, m.default)("body").removeClass("overflow-on-vertical-view"), this.viewOpts.useCustomCursor) {
        ...
        render: function() {
            ...
            t && t.markAsLast(), this.viewOpts.viewertype === "horizontal" && this.setPagesTransitions(), RM.screenshot || this.renderControls(), this.onResize(), this.viewOpts.viewertype === "vertical" && (u.isDesktop() && this.getPage(1) && this.getPage(1).$content.focus(), (0, m.default)("body").on("keydown", this.onVerticalViewKeyDown)), u.isDesktop() ? ((0, m.default)(window).on("mousedown", this.onMouseDown), (0, m.default)(window).on("mouseup", this.onMouseUp), (0, m.default)(window).on("mousewheel", this.onMouseWheel)) : ((0, m.default)(window).on("touchstart", this.onDragStart), (0, m.default)(window).on("touchmove", this.onDragMove), (0, m.default)(window).on("touchend touchcancel", this.onDragEnd), (0, m.default)(window).on("pageshow", this.onResize)), _.PageVisibilityManager.addEventListener(this.onPageVisibilityChange), (0, m.default)(window).on("resize", this.onResize), this.isPreview && (this.listenTo(this.model, "change:opts", (s, a) => {
                ...
                this.onOptionsChange({ ...p,
                    ...c
                }, a ? .opts, "phone_portrait")
            }), this.listenTo(this.model, "change:viewport_tablet_portrait", (s, a) => {
                let p = this.model.get("opts"),
                    c = s.previous("viewport_tablet_portrait") ? .opts ? ? {};
                this.onOptionsChange({ ...p,
                    ...c
                }, a ? .opts, "tablet_portrait")
            }), this.on("change:viewport", ({
                viewport: s,
                oldViewport: a
            }) => {
                this.onOptionsChange(this.getViewportOptions(a), this.getViewportOptions(s), s)
            })), u.isDesktop() || (0, m.default)(window).on("orientationchange", this.onOrientationChange), (0, m.default)(window).on("gesturestart gestureend", this.onGestureChange), this.viewOpts.viewertype == "vertical" && this.$magScrollHandler ? .on("scroll", this.onMagScroll), (0, m.default)("body").on("keyup", this.onKeyup), K.generateCSS("paragraph", "viewer", document, this.edit_params && this.edit_params.paragraph_styles), K.generateCSS("link", "viewer", document, this.edit_params && this.edit_params.link_styles), !(RM.screenshot && Ce("pdf") == "true") && !this.isPreview && K.setShortList(K.getVeryShortList(this.edit_params && this.edit_params.fonts));
            ...
            return this.globalEvents ? .start(), this
        },
        destroy: function() {
            return g.default.each(this.pages, function(e) {
                e.destroy()
            }), this.pages = null, this.globalEvents ? .destroy(), B.off("ecwid:checkout:opened", this.onEcwidOpened.bind(this)), B.off("ecwid:checkout:closed", this.onEcwidClosed.bind(this)), (0, m.default)("body").off("click", "a.external-link", this.toExternalLink).off("click", ".maglink.back-to-top", this.backToTopCurrentPage).off("click", ".maglink", this.maglink).off("click", ".goback-link", this.onGobackLinkClick).off("click", ".mailchimp-link", this.onMailchimpLinkClick).off("click", ".anchor-link", this.onAnchorLinkClick).off("keydown", this.onVerticalViewKeyDown).off("click", ".share-link", this.onShareLinkClick), this.destroyControls(), this.cartSidebar && setTimeout(() => {
        ...
        renderControls() {
            this.viewOpts.viewertype === "horizontal" && this.viewOpts.arrows && (this.navigation = new at({
                mag: this,
                router: this.router,
                $container: this.$el,
                isPreview: this.isPreview,
            ...
            let e = (window.location.href.indexOf(`${U.readymag_host}/designs/`) > -1 || this.isPublishedAsTemplate) && !this.isPreview,
            ...
            this.toolbar = new gi({
                ...
                hasShare: this.viewOpts.sharebutton && !U.IS_FILE_PROTOCOL,
                hasPageCounter: this.viewOpts.pagecounter,
                controlsOnTop: this.viewOpts.controlsontop,
                brandingInToolbar: i,
                viewerType: this.viewOpts.viewertype,
                publishDate: this.published ? vt(new Date(this.published), "MMM dd, yyyy") : "unpublished",
                defaultHidden: this.defaultHideToolbar
            }).render(), (t || e) && (this.model.set("startWithTemplate", e), this.model.set("isPublishedAsTemplate", this.isPublishedAsTemplate), this.model.set("isMobile", u.isMobile()), Fe({
                component: Kt,
                domElement: i ? this.toolbar.$el.find(".toolbar-branding")[0] : this.$el.find(".rm-branding")[0],
                model: this.model
            })), this.viewOpts.viewertype === "vertical" && (this.$bottomArrow = this.$(".navigation-arrow.bottom"), this.$bottomArrow.on("click", this.scrollMagALittle))
        },
        destroyControls() {
            this.toolbar ? .destroy(), this.branding ? .destroy(), this.navigation ? .destroy(), this.$bottomArrow ? .off("click", this.scrollMagALittle)
        },
        ...
        rerenderPage(e, t) {
            ...
            o && o.length && r.$el.remove().insertBefore(o), r.render(), this.pages[i] = r, e._id === this.currentPage ? ._id && (this.currentPage = void 0), this.onResize()
        },
        getUrl: function() {
        ...
        onPageVisibilityChange: function() {
            if (this.currentPage)
                if (clearTimeout(this.visibilityHandlerTimeout), _.PageVisibilityManager.isPageHidden()) this.visibilityHandlerTimeout = setTimeout(() => {
        ...
        onDragMove: function(e) {
            ...
            if (_.isPageNativelyScaled()) return;
        ...
        checkDoubleTap: function(e) {
            ...
            if (this.lastTouchEndTime = t, i < 500 && i > 0 && _.isPageNativelyScaled()) {
        ...
        onKeyup: function(e) {
            ...
            if ((e.keyCode >= 49 && e.keyCode <= 51 || String.fromCharCode(e.keyCode) === "D") && (this.viewportCounter = ie.incrementCircular(this.viewportCounter, r)), String.fromCharCode(e.keyCode) === "D" ? o = String(this.viewportCounter) : o = String.fromCharCode(e.keyCode), o === "1" ? n = "default" : o === "2" && t ? n = "tablet_portrait" : o === "3" && i || o === "2" && !t ? n = "phone_portrait" : n = void 0, n && this.isPreview) {
                ...
                p && a !== p ? RM.constructorRouter ? .preview.restartMag({
                    viewport: n
        ...
        onVerticalViewKeyDown: function(e) {
            if (!(this.isInPresentationMode || this.viewOpts.viewertype !== "vertical") && (e.which === m.default.keycodes.down || e.which === m.default.keycodes.up)) {
                ...
                let i = window.innerHeight,
                    ...
                    v, M;
                if (t) v = c - r - i, s(v) ? M = c - r : a(v) ? M = v : M = i, w && this.viewOpts.slidein && (M += p());
                else {
                    if (w) {
        ...
        showBottomButton: function() {
            this.$bottomArrow ? .removeClass("offscreen")
        },
        ...
        onMailchimpLinkClick: function(e) {
            ...
            if (!t.hasClass("disabled")) {
                ...
                i && xt.initMailchimpAPI(function(o) {
                    kt("MCEvilPopupClosed"), o.start(i)
                })
            }
        },
        ...
        refreshPagesAfterScroll: function({
            ...
            o(), this.whenWidgetsCreated[i._id] ? .then(r), this.pages.forEach(n => {
                n.num >= e && n.num <= t && n._id !== i._id && this.whenWidgetsCreated[n._id] ? .then(() => this.loadPages())
            })
        },
        ...
        goNextPage: function(e) {
            this.isLastPage() || this.currentPage && this.router.go(this.currentPage.num + 1, { ...e,
                isPageNum: !0
            })
        },
        goPrevPage: function(e) {
            this.isFirstPage() || this.currentPage && this.router.go(this.currentPage.num - 1, { ...e,
                isPageNum: !0
            })
        },
        ...
        loadPages: function() {
            if (it.setTiming("load_pages_start", Date.now()), !this.pages || !this.pages.length) return;
        ...
        renderNextWidgetPack: function() {
            if (!this.widgetsPacksLoadQueue.length) {
                it.setTiming("load_pages_end", Date.now()), lt.default.trigger("widgetsQueue:empty", this.num_id);
                return
            }
        ...
        onResize: function() {
            ...
            if (!u.isDesktop() && this.prevOrientation && this.prevOrientation !== t) {
                let n = this.getPage(this.currentPage.num - 1),
                    s = Ve.findPlayingVideo(this.currentPage.widgets) || Ve.findPlayingVideo(n ? .widgets),
            ...
            if (g.default.each(this.pages, g.default.bind(function(n, s) {
                ...
                let n = this.$magScrollSizer ? .width(),
                    s = 0;
                ...
                if (this.$magScrollSizer ? .css("height", this.magHeight + s), n != this.$magScrollSizer ? .width() && u.isDesktop() && this.onResize(), this.currentPage) {
                    if (!this.isStickyVerticalViewer && !this.hadPlayingVideoOnResize) this.setScroll(this.getScrollPosForNewSize()), this.onMagScroll();
                    else if (i && !this.hadPlayingVideoOnResize) {
        ...
        onOptionsChange(e = {}, t = {}, i = "default") {
            let o = n => i !== "default" ? t[n] !== e ? .[n] && Pt.includes(n) : t[n] !== e ? .[n];
            i === "default" && (this.opts = t), o("projectinfo") && this.toolbar.changeProjectInfoVisible(t.projectinfo);
            let r = o("arrows");
            r && t.viewertype === "horizontal" && t.arrows ? (this.navigation ? .destroy(), delete this.navigation, this.navigation = new at({
                mag: this,
                router: this.router,
                $container: this.$el,
                isPreview: this.isPreview,
...
`
        ...
        matchSameDomainLink: function(e) {
            let t = e.match(new RegExp("//" + _.escapeSpecial(window.location.hostname) + "/(.*)")),
                i = t && t[1];
            if (i) {
        ...
        getAllWidgetViewsById(e, t) {
            ...
            return i && !o ? this.pages.filter(n => n.hasWidget ? .(e)).map(n => this.getWidgetById(e, n)) : [this.getWidgetById(e, t)]
        },
        ...
        getWidgetById: function(e, t) {
            let i, o, r, n = t ? .hasWidget ? .(e) ? t : this.pages.find(s => s.hasWidget ? .(e));
        ...
        renderAboveGlobalWidgets: function(e) {
            ...
            g.default.each(this.aboveGlobalWidgetsData, function(o) {
                ...
                if (o) {
                    ...
                    fe[s.type] && !a && (n = new fe[s.type](s, e), n.$fixedContainer = this.$aboveWidgetsContainer, n.isValid() && t.push(n))
                }
            ...
            }), this.aboveGlobalWidgets = Ie(t), this.aboveGlobalWidgetsRendered = !0, this.trigger("aboveGlobalWidgetsRendered")
        },
        ...
        getAboveGlobalBox: function(e, t, i) {
            ...
            return It.getFixedPositionBox(r.fixed_position, g.default.pick(r, ["x", "y", "w", "h"]), t.scale, i)
        },
        redrawAboveGlobalWidgets: function(e, t, i, o) {
            ...
            if (g.default.isUndefined(i)) {
                ...
                g.default.each(this.aboveGlobalWidgets, function(a) {
                    let p = e._id && n(a, e);
                    e._id && a.updatePage(e), p && this.updateAboveGlobalViewport(a, e), e._id && !L.isHidden(a, e._id, this.isPreview) && !e.isPasswordProtected() ? o ? a.wasHidden && _.waitForTransitionEnd(e.$el, s, "transform", L.show.bind(null, a)) : a.wasHidden && L.show(a) : !a.wasHidden && L.hide(a)
                }.bind(this))
            } else {
                let s = Math.abs(i);
                g.default.each(this.aboveGlobalWidgets, function(a) {
        ...
        getUsedFonts(e = {}) {
            return K.getUsedFontsFromWidgetsModels({ ...e,
        ...
        hasNewTextWidgets() {
            return this.hasTextWidgetsV3 || Zt(this.model.attributes) || qt(this.aboveGlobalWidgetsData)
        },
        hasCodeInjection: function() {
            ...
            return g.default.each(this.pages, function(i) {
                g.default.each(i.widgetsData, function(o) {
                    ...
                    let s = (0, wi.getEmbedType)(o.code) === "codeinjection";
                    if (!s) return;
        ...
        setupEcommerceSidebar: function() {
            this.eCommerceManager ? .getConnectedProvider() === "ecwid" ? this.cartSidebar = new Qt(this) : this.cartSidebar = new jt(this)
        },
        closeMagMenu() {
    ...
    kn = Ji;
export {
    We as a, co as b, Ve as c, it as d, kn as e
};