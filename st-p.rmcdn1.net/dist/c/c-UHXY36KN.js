...
function H(o, r) {
    r(o, "default");
    for (let e of y) r(o[`${c}${e}`], e)
}
var f, z, F, c, l, n, v, a, d, u, i, s, h, m, b, x, T, k, V, P, y, O, E, K, D = _(() => {
    "use strict";
    g();
    w();
    f = (t => (t.Default = "default", t.TabletPortrait = "tablet_portrait", t.PhonePortrait = "phone_portrait", t))(f || {}), z = {
        default: "Desktop",
        ...
        shortcut: "2"
    }], n = ["x", "y", "w", "h", "z", "hidden", "angle", "flip_h", "flip_v", "pack_id", "fixed_position", "is_full_width", "is_full_height", "sticked", "sticked_margin", "_hidden"], v = {
    ...
    }, a = [...n, "animation", "triggers", "shadow", "isShadowEnabled", "modifiers"], d = p("constructor.disableViewportBackgroundCascading"), u = ["color", "opacity", "selectedType", "picture", "slideshow"];
    d && u.push("video");
    i = Object.fromEntries(Object.entries({
        ...
        lottie: ["interactions"],
        video: ["autoplay", "loop", "mute", "video_styles", "custom_controls", "controls", "controls_type"]
    }).map(([o, r]) => [o, [...r, ...a]])), s = ["hidden", "z"], h = "_", m = s.map(o => h + o), b = l.map(o => c + o.name), x = b.filter(o => o !== "viewport_default"), T = function(o) {
        return i[o] || a
    }, k = {
        background: d ? ["slideshow"] : ["picture", "slideshow"]
    }, V = l.reduce((o, r) => (o[r.name] = r, o), {}), P = ["default", "phone_portrait", "tablet_portrait"], y = ["phone_portrait", "tablet_portrait"], O = ["arrows", "menubutton", "sharebutton", "pagecounter", "branding", "endpage", "viewertype", "projectinfo", "lqip"], E = (o, r, e = !0) => {
        let t = [];
        return o === "text" && r === 2 ? t = i["text.v2"] : t = i[o] || a, e ? [...t, ...s] : t
    };
    K = {
        viewports: l,
        dictionary: V,
        ...
        widgetViewportFields: T,
        primitiveFields: n,
        primitiveFieldsByWidgetType: v,
        cascadingFields: k,
        types: P,
        mobileTypes: y,
        globalKeys: s,
