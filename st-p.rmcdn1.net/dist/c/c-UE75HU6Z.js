...
var t, p, o, b, x, f = a(() => {
    ...
    b = p.default.View.extend({
        ...
        events: {
            ...
            "click .close-button": "hideOnCloseBtnClick",
            click: "hideOnBgClick",
        ...
        initialize: function(e) {
            o.default.bindAll(this), o.default.extend(this, e), this.opts = this.opts || {}, this.router = this.router || RM.collectorRouter || RM.constructorRouter
        },
        render: function() {
            this.setElement((0, t.default)(this.template({
                opts: this.opts,
                readymagHost: s.readymag_host
            }))), this.$parent && (this.$parent instanceof Element && (this.$parent = (0, t.default)(this.$parent)), this.$parent.append(this.$el).addClass("visible")), o.default.delay(o.default.bind(function() {
                this.$el.addClass("show")
            }, this), 50), (0, t.default)("body").on("keyup", this.onBodyKeyUp), RM.common.disableShortcuts.alert = !0
        },
        hide: function() {
            delete RM.common.disableShortcuts.alert, (0, t.default)("body").off("keyup", this.onBodyKeyUp), this.$el.removeClass("show").addClass("hide"), o.default.delay(o.default.bind(function() {
