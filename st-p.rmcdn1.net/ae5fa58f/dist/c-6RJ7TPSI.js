...
function V(y, m) {
    ...
    if (m.addEventListener) {
        ...
        n.version = "1.5.6", n.isSupported = !0, n.instances = [], n.p = n.prototype = {
                init: function(t, e) {
                    ...
                    if (typeof t == "function") {
                        if (m.readyState === "complete") t(m, n);
                        else if (w.push(t), !N) {
                            N = !0;
                            var s = function() {
                            ...
                            m.addEventListener("DOMContentLoaded", s, !1)
                        }
                    } else {
                ...
                for (var e = n.instances, r = e.length, i = 0; i < r; i++)
                ...
                disable: function(t, e) {
                    if (!t.data.disabled[e]) {
                        if (t.data.disabled[e] = !0, e in n.registryByName && t.data.running[e])
                            for (var r = t.data.running[e].length - 1, i; r >= 0; r--) i = t.data.running[e][r], i._natives.end.call(t, null, i), t.emit("trackend", n.extend({}, i, {
                                plugin: i.type,
                                type: "trackend"
                            }));
                        return t
                ...
                enable: function(t, e) {
                    if (t.data.disabled[e]) {
                        if (t.data.disabled[e] = !1, e in n.registryByName && t.data.running[e])
                            for (var r = t.data.running[e].length - 1, i; r >= 0; r--) i = t.data.running[e][r], i._natives.start.call(t, null, i), t.emit("trackstart", n.extend({}, i, {
                                plugin: i.type,
                                type: "trackstart",
                                track: i
                            }));
                ...
                exec: function(t, e, r) {
                    ...
                    if (typeof u == "number" && (t = u), typeof t == "number" && i === 2) r = e, e = t, t = n.guid("cue");
                    else if (i === 1) e = -1;
                    else if (d = this.getTrackEvent(t)) this.data.trackEvents.remove(t), E.end(this, d), n.removeTrackEvent.ref(this, t), s = "cuechange", typeof t == "string" && i === 2 && (typeof e == "number" && (r = d._natives.start), typeof e == "function" && (r = e, e = d.start));
                    else if (i >= 2) {
                        if (typeof e == "string") {
                            try {
            ...
            }, n.Events.Natives = n.Events.UIEvents + " " + n.Events.MouseEvents + " " + n.Events.Events, T.events.apiTypes = ["UIEvents", "MouseEvents", "Events"],
            function(t, e) {
                ...
                getInterface: function(t) {
                    ...
                    var e = T.events,
                        r = e.apiTypes;
                    e = e.apis;
                    for (var i = 0, s = r.length, d, u; i < s; i++)
                        if (u = r[i], e[u][t]) {
                            d = u;
                            break
                        }
                ...
                fn: {
                    ...
                    listen: function(t, e) {
                        ...
                        return this.data.events[t] || (this.data.events[t] = [], i = !1), s && (s.add && s.add.call(this, {}, e), s.bind && (t = s.bind), s.handler && (u = e, e = function(p) {
                            ...
                            if (r.data.events[t])
                                for (d = r.data.events[t].slice(); d.length;) d.shift().call(r, p)
                        }, !1), this
                    },
                ...
                return (this.parent.getTrackEvents() || []).filter(function(e) {
                    ...
                    if (!t) return !0;
                    for (r in t)
                        if (i = t[r], e[r] && e[r] === i || e._natives[r] && e._natives[r] === i) return !0;
                    return !1
                })
                ...
                var e = this.byStart,
                    r = this.byEnd,
                    i;
                for (t && t._id && this.parent.data.history.push(t._id), t.start = n.util.toSeconds(t.start, this.parent.options.framerate), t.end = n.util.toSeconds(t.end, this.parent.options.framerate), i = e.length - 1; i >= 0; i--)
                    if (t.start >= e[i].start) {
                        e.splice(i + 1, 0, t);
                        break
                    }
                ...
                if (i = this.animating.length, s = 0, i)
                    for (; --i > -1;) e = this.animating[s], e._id || c.push(e), e._id && e._id !== t && c.push(e), s++;
                ...
                var r = t.media.currentTime,
                    ...
                    l, a, o;
                if (i <= r) {
                    for (; s.byEnd[d] && s.byEnd[d].end <= r;)
                        if (l = s.byEnd[d], a = (i = l._natives) && i.type, !i || h[a] || t[a]) l._running === !0 && (l._running = !1, o = t.data.running[a], o.splice(o.indexOf(l), 1), t.data.disabled[a] || (i.end.call(t, e, l), t.emit("trackend", n.extend({}, l, {
                            plugin: a,
                            type: "trackend",
                            track: l
                        })))), d++;
                    ...
                    for (; s.byStart[u] && s.byStart[u].start <= r;)
                        if (l = s.byStart[u], a = (i = l._natives) && i.type, !i || h[a] || t[a]) l.end > r && l._running === !1 && (l._running = !0, t.data.running[a].push(l), t.data.disabled[a] || (i.start.call(t, e, l), t.emit("trackstart", n.extend({}, l, {
                            plugin: a,
                            type: "trackstart",
                            track: l
                        })))), u++;
                    ...
                    for (; s.byStart[u] && s.byStart[u].start > r;)
                        if (l = s.byStart[u], a = (i = l._natives) && i.type, !i || h[a] || t[a]) l._running === !0 && (l._running = !1, o = t.data.running[a], o.splice(o.indexOf(l), 1), t.data.disabled[a] || (i.end.call(t, e, l), t.emit("trackend", n.extend({}, l, {
                            plugin: a,
                            type: "trackend",
                            track: l
                        })))), u--;
                    ...
                    for (; s.byEnd[d] && s.byEnd[d].end > r;)
                        if (l = s.byEnd[d], a = (i = l._natives) && i.type, !i || h[a] || t[a]) l.start <= r && l._running === !1 && (l._running = !0, t.data.running[a].push(l), t.data.disabled[a] || (i.start.call(t, e, l), t.emit("trackstart", n.extend({}, l, {
                            plugin: a,
                            type: "trackstart",
                            track: l
                        })))), d--;
                ...
                if (n.protect.natives.indexOf(t.toLowerCase()) >= 0) n.error("'" + t + "' is a protected function name");
                else {
                    ...
                    n.p[t] = u[t] = function(l, a) {
                        var o, g;
                        if (l && !a) a = l;
                        else if (o = this.getTrackEvent(l)) {
                            g = a;
                            var v = {},
                                f;
                            for (f in o) _.call(g, f) && _.call(o, f) && (v[f] = o[f]);
                            if (o._natives._update) this.data.trackEvents.remove(o), _.call(a, "start") && (o.start = a.start), _.call(a, "end") && (o.end = a.end), E.end(this, o), i && e.call(this, o), o._natives._update.call(this, o, a), this.data.trackEvents.add(o), E.start(this, o);
                            else return n.extend(o, a), this.data.trackEvents.remove(l), o._natives._teardown && o._natives._teardown.call(this, o), n.removeTrackEvent.ref(this, l), i ? c.call(this, e.call(this, o), o) : (o._id = o.id || o._id || n.guid(o._natives.type), o._natives && o._natives._setup && (o._natives._setup.call(this, o), this.emit("tracksetup", n.extend({}, o, {
        ...
        n.xhr = function(t) {
            if (t.dataType = t.dataType && t.dataType.toLowerCase() || null, t.dataType && (t.dataType === "jsonp" || t.dataType === "script")) n.xhr.getJSONP(t.url, t.success, t.dataType === "script");
            else if (t = n.extend({}, M, t), t.ajax = new XMLHttpRequest, t.ajax) return t.type === "GET" && t.data && (t.url += (D.test(t.url) ? "&" : "?") + t.data, t.data = null), t.ajax.open(t.type, t.url, t.async), t.type === "POST" && t.ajax.setRequestHeader("Content-Type", t.contentType), t.ajax.send(t.data || null), n.xhr.httpData(t)
