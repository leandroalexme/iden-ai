...
function S({
    ...
    return (0, u.useEffect)(() => (e.on("change", m), () => {
        e.off("change", m)
    }), [e]), r(p.Provider, {
        value: { ...l,
            ...f,
...
function O({
    ...
    let f = {
        ...
        m = t => {
            let a = t.get("_id");
            b(o => {
                let n = o.collection.findIndex(v => v._id === a);
                if (n === -1) return {
    ...
    return (0, u.useEffect)(() => (e.on("change", m), e.on("add", i), e.on("remove", s), () => {
        e.off("change", m), e.off("add", i), e.on("off", s)
    }), [e]), r(p.Provider, {
        value: { ...l,
            ...f
        },
...
var u, g, k, R, N, _ = w(() => {
    ...
    N = ({
        ...
        let b = p ? r(y, {
            ...
            m = l ? k.default.createRoot(e) : null;
        ...
        function s() {
            l && (m.unmount(), m = k.default.createRoot(e))
        }
        return l || g.default.render(b, e, f), {
            render: i,
            unmount: s
        }
    }
...
export {
    R as a, S as b, O as c, E as d, N as e, U as f, _ as g
};