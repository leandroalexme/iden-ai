...
var U = i => {
        ...
        switch (i) {
            case "Drag/WidgetRendered":
                t =
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-X6F7GZUJ.js");
                break;
            case "Drag/PointerDown":
                t =
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-L7VE52YS.js");
                break;
            case "Drag/PointerUp":
                t =
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-XCHOQXO6.js");
                break;
            case "Drag/PointerMove":
                t =
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-OL6Z2AIX.js");
                break;
            case "Drag/DragStart":
                t =
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-GQHFTRXH.js");
                break;
            case "Drag/TouchEnd":
                t =
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-PEBVJ2FT.js");
                break;
            case "Cursor/WidgetRendered":
                t =
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-SJAJ2WZ2.js");
                break;
            default:
...
var G = 1,
    N = L.default.View.extend({
        template: E["template-viewer-widget"],
        ...
        initialize: function(i, t, e) {
            return g.default.bindAll(this), g.default.extend(this, L.default.Events), this.updateWidgetData(i, t, e), this.initStaticModifiers(), t.getPageViewport() !== "default" && this.sticked !== "bottom" && (this.sticked = void 0), this.destroyed = !1, this.$document = (0, v.default)(document), this._id = this._id || G++, this.initModifiersWithEventHandlers(), this
        },
        render: function() {
        ...
        redrawShadow: function({
            ...
            t && i && window.requestAnimationFrame(() => {
                let f = o && i.fadeOnHover ? "ffffff00" : i.color,
        ...
        makeSureFontsLoaded: function() {
            let i = this.page.getFontsVariations([this], !0),
                t = [];
            return g.default.each(i, function(e) {
                try {
        ...
        initStaticModifiers() {
            this.modifiers ? .length && this.modifiers.forEach(i => {
                if (i.static ? .length && i.static.forEach(t => {
        ...
        initModifiersWithEventHandlers() {
            if (this.modifiers ? .length) {
                ...
                if (this.modifiers.forEach(t => {
                        t.events ? .length && t.events.forEach(e => {
        ...
        checkAllHandlersLoadStatus(i) {
            let t = Object.keys(i),
                ...
                s = 0;
            t.forEach(o => {
                s += 1, i[o] ? .isElementLoaded && i[o] ? .isGlobalLoaded && (e += 1)
        ...
        addModifierEventListener(i) {
            this[`on${i}`] || (this[`on${i}`] = (t, e) => {
                this.modifiersHandlers ? .[i] ? .[t] ? .length && this.modifiersHandlers[i][t].forEach(s => {
                    s.default && s.default({
                        widget: this,
                        e
                    })
        ...
        startModifiersEventListeners() {
            if (!(!this.modifiersHandlers || this.modifiersEventListenersAdded)) {
                ...
                for (let i in this.modifiersHandlers) {
                    ...
                    if (!this[`on${i}`] && (t ? .element ? .length || t ? .global ? .length) && this.addModifierEventListener(i), t ? .element ? .length) switch (i) {
                        case "rendered":
                            this[`on${i}`]("element");
                            break;
                        default:
                            this.$el[0] ? .addEventListener(i, this[`on${i}`].bind(this, "element"))
                    }
                    if (t ? .global ? .length) switch (i) {
                        case "pointermove":
                            this.mag.globalEvents ? .on({
                                id: this._id,
        ...
        stopModifiersEventListeners() {
            if (!(!this.modifiersHandlers || !this.modifiersEventListenersAdded)) {
                ...
                for (let i in this.modifiersHandlers) {
                    let t = this.modifiersHandlers[i];
                    if (t ? .element ? .length && this.$el[0] ? .removeEventListener(i, this[`on${i}`]), t ? .global ? .length) switch (i) {
                        case "pointermove":
                            this.mag.globalEvents ? .off({
                                id: this._id,
        ...
        softBringToTopZ() {
            let t = (this.is_above ? this.mag.aboveGlobalWidgets : this.page.widgets) ? .reduce((s, o) => o.z && o.z > s ? o.z : s, this.z),
        ...
        calcBoxStyle: function(i) {
            ...
            let t = {
                ...
                f = parseInt(this.sticked_margin, 10) || 0,
                n = this.page.scale,
                m = e.width,
                d = m - e.windowClientWidth,
                a = this.fixed_position,
                c, l = this.page.getCachedSizes();
            ...
            if (i.calcBBox) {
                ...
                let h = $.calcBoundingBox(t, a);
                return t.width = h.bb_width, t.height = h.bb_height, t.left = h.bb_left, t.top = h.bb_top, a && g.default.extend(t, w.getFixedPositionCSS(a, t, 1)), {
                    dimensions: t
                }
            }
            if (a) {
                let h = this.page.mag.getViewportWidth(this.page.pageViewport);
                g.default.extend(t, w.getFixedPositionCSS(a, t, p.normalize(n, "transform", this.page.pageViewport, h, this.mag.viewOpts))), p.isOn(this.page.pageViewport, h, this.mag.viewOpts) && p.isCSSZoom() && (t.zoom = n)
            }
            let r = {
        ...
        applyBoxStyle: function(i) {
            ...
            this.isDraggable && !i ? .onFirstRender && delete t.dimensions["z-index"], this.animationObj && (t = this.animationObj.modifyWidgetPosition(t)), this.$el.css(t.dimensions), g.default.isEmpty(t.decorations) || this.$el.css(t.decorations);
            let e = g.default.map(t.transform, function(s, o) {
                return s ? o + "(" + s + ")" : ""
            }).join(" ");
            w.applyTransform(this.$el, v.default.trim(e))
        },
        calcDistsToPageVisibleBounds: function() {
            let i, t = this.page.mag.getContainerSizeCached(),
                ...
                f = (t.height - (e.top + e.height / 2 - s.top)) / this.page.scale,
            ...
            if (this.fixed_position) {
                ...
                i = {
                    ...
                    bottom: Math.max(0, Math.min(f, a))
                }
            } else {
        ...
        checkLink: function() {
            let i = {};
            if (!this.clickLink || !M(this)) return;
            ...
            let t = /^(.*):\/\/[^\s$.?#].[^\s]*$/i.test(this.clickLink) || /^mailto\:/i.test(this.clickLink) || /^tel\:/i.test(this.clickLink),
                ...
                f = this.shareRegexp.test(this.clickLink);
            var n = this.clickLink,
                m = C(this.clickTarget, this.clickLink),
                d = t ? "external-link" : e ? "goback-link" : "maglink";
            if (s && (d = "mailchimp-link"), o && (d = "anchor-link"), f && (d = "share-link"), !t) {
                let r = n;
            ...
            if (o) {
                ...
                let r = g.default.findWhere(this.mag.pages, {
                    _id: this.clickPage
                }) || this.page;
            ...
            (this.insideHotspot ? typeof this.closeTip == "boolean" ? this.closeTip : !0 : !1) && (d += " close-tip-on-click"), g.default.extend(i, {
                class: d,
                href: n,
                target: m
            });
        ...
        updateWidgetData: function(i, t, e) {
            g.default.extend(this, i, i.params), this.page = t, this.mag = this.page.mag, this.$pageContainer = e || this.page.$content, this.x = this.x || 0, this.y = this.y || 0;
            let s = null;
            this.is_global ? this.is_above ? s = t ? .mag ? .aboveGlobalWidgetsData ? .find(o => o._id === this._id) : s = t ? .mag ? .staticGlobalWidgetsData ? .find(o => o._id === this._id) : t ? .widgetsData && (s = t.widgetsData ? .find(o => o._id === this._id)), this.currentWidgetData = s || g.default.extend({}, i, i.params)
        },
        getAnimations() {
