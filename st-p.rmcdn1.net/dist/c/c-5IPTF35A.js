...
var N = D(() => {
    ...
    (function(h, d) {
        ...
        l.prototype = Object.create(r.prototype), l.prototype.sound_position = function() {
            ...
            u(t, "soundcite-initializing"), u(t, "soundcite-force-bg-color"), m.update_playing_element(t, 0, k(t)), t.getAttribute("data-url") && (b == "none" ? (g.push(t),
                import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-6RJ7TPSI.js").then(({
                    default: e
                }) => {
