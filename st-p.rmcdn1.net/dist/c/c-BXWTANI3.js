...
function s() {
    return e() ? !1 : window.screen ? window.matchMedia ? window.matchMedia("(orientation: portrait)") ? .matches : window.orientation === 0 ? !0 : window.orientation === 90 || window.orientation === -90 ? !1 : window.innerWidth < window.innerHeight : window.innerWidth < window.innerHeight
}
...
function n() {
    return e() ? !1 : window.matchMedia ? window.matchMedia("(pointer: coarse)") ? .matches : !1
}
