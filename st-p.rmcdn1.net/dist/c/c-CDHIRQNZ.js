import {
    a as A
} from "https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-SSTGP4HO.js";
import {
    a as F,
    b as M,
    c as T
...
function U({
    ...
    (0, s.useEffect)(() => {
        ...
        function o() {
            e ? .direction === -1 ? t.seek(e.range ? .[1] || t.state.totalFrames - 1 || 0) : e.range && t.seek(e.range[0] || 0)
        }
    ...
    function P(e) {
        ...
        let e = n.scroll;
        if (!e) return;
        let o = e.scrollType !== "relative" ? e.loopInfinite ? ? !0 : !1;
        t.seek(E({
            range: e.range,
            percent: d,
            totalFrames: t.state.totalFrames,
            direction: e.direction,
            loopCount: e.loop ? o ? h : e.loopCount ? ? 1 : 1,
            bounce: e.loop === "swing"
        }))
