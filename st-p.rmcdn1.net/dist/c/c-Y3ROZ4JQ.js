...
var u, q, P, R = f(() => {
    ...
    q = 6, P = class {
        ...
        getImageUrl(e, a, t, s) {
            let n = t || (s && y() ? "webp" : "jpg");
            return `${e}/${a.toString().padStart(q,"0")}.${n}?c`
        }
    }
});
var I, b, N, k, _ = f(() => {
    "use strict";
    F();
    I = 400, b = 16.66, N = Math.floor(I / b), k = class {
        constructor(e, a, t) {
            i(this, "canvas");
            i(this, "imageLoader");
            i(this, "easingType", 1);
        ...
        startDrawingByStep(e, {
            ...
            let c = o => {
                ...
                let h = Math.min((o - d) / r, 1),
                    g = Math.floor(h * (e - 0) + 0) / 1;
                this.drawImageByIndex(this.byStepReverse ? e - g : g).then(() => {
                    h === 1 && t ? (d = o, s && (this.byStepReverse = !this.byStepReverse)) : h === 1 && (this.isPlayingAnimation = !1), this.isPlayingAnimation && window.requestAnimationFrame(c)
                })
            };
        ...
        startEasingSequence(e) {
            ...
            return new Promise(t => {
                let s = Date.now(),
                    ...
                    d = Math.min(Math.round(this.imageLoader.getNumberOfImages() * .05), N, this.easingType === 0 ? r : Math.ceil(I / n));
