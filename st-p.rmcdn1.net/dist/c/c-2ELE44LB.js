...
var P, J, X, Q, Y, Z, tt, U, et, nt, rt, ot, Rt, Ut, lt = S(() => {
    "use strict";
    q();
    O();
    W();
    ...
    P = t => {
        ...
        if (s.startsWith("mailto:")) i.url = s.replace("mailto:", ""), i.type = "Email";
        else if (s.startsWith("tel:")) i.url = s.replace("tel:", ""), i.type = "Phone";
        else if (s === "__rm_anchor") i.url = `${g}px`, i.pageNum = e ? .getCurrentPageNum() || void 0, i.type = "Anchor", i.anchorPosition = g;
        else if (s === "back to top") i.url = "", i.type = "ScrollToTop";
        else if (s === "__rm_goback") i.url = "", i.type = "GoBack";
        else if (c || e ? .mag.getPageId(s)) {
            let p = e ? .mag.getPageId(s);
            i.url = "" + (c && e ? .mag.getPageUri(c) || p || s);
            let f = c || p;
            i.pageNum = f && e ? .mag.getPageNum(f) || void 0, i.type = "Page", i.pageId = f || void 0
        ...
        if (t === "color") return y("COLOR", x(T(e)));
        ...
        return t.forEach(({
            ...
            r.blocks.push(K), r.styles.push(H), r.blocksMeta.push(N), r.entityMap = { ...r.entityMap,
                ...i
            }
        }), n ? .length && Object.keys(r.entityMap).forEach((l, a) => {
            r.entityMap[l].data = { ...r.entityMap[l].data,
                id: n[a]
            }
        }), r
    }, ot = t => {
...
`);
        ...
        return r.parentNode ? .removeChild(r), l
    }, Ut = t => {
        let e = P(t),
...
export {
    d as a, z as b, it as c, R as d, J as e, Y as f, Rt as g, Ut as h, lt as i
};