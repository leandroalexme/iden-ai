...
var S = class extends f {
        constructor() {
            ...
            a(this, "handlePointerMovement", function(e) {
                ...
                let n = o.currentTarget,
                    ...
                    c, l;
                if (n instanceof Window) c = o.clientX, l = o.clientY;
                else {
                    let p = n instanceof Window || E.isCSSTransform() ? 1 : this.page.scale,
                        g = y.mapPointerToElement(o, n, 1, p);
                    c = g.left, l = g.top
                }
                let s = Math.sqrt(i.width ** 2 + i.height ** 2),
                    d = y.percentFromRectangleCenter(i, {
                        x: c,
                        y: l
                    }),
                    h = 0;
        ...
        async render() {
            if (!this.model.attributes.uri) return this;
            ...
            import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-UV2LB3O3.js");
            this.sharedState = w({ ..._(),
                viewport: this.page.getPageViewport()
            });
            let r = this.model.attributes.interactions ? .some(n => n.type === "click");
            return this.el.classList.toggle("interactive", r), t({
                ...
                n && (this.widgetIsLoaded(), this.unsubscribePlayerReady ? .())
        ...
        getWindow() {
            return window.RM ? .constructorRouter ? .previewMode && this.page.getPageViewport() !== "default" && document.querySelector("#mags .mag-pages-container") || window
        }
        async bindTriggers() {
            for (let t of this.model.attributes.interactions || []) {
                let e = t.triggers ? .length ? t.triggers : [this.model.attributes._id];
                for (let r of e) {
                        ...
                        if (i instanceof HTMLElement) {
                            switch (t.type) {
                                ...
                                case "cursor":
                                    ...
                                    break;
                                case "scroll":
                                    this.isAbove() && this.getViewerType() === "vertical" ? this.listenTo(this.page.mag, "mag_scroll", this.handleScroll) : (this.listenTo(this.page, "page_scroll_unlim", this.handleScroll), this.handleScroll(this.page.getScroll(!0) ? ? 0));
                                    break
                            }
        ...
        handleScroll(t) {
            ...
            let r = 0,
                ...
                d = 0,
                h = e.scrollRange ? .[0] ? ? 0,
                p = e.scrollRange ? .[1] ? ? 100,
                g = e.scrollDelay ? ? 0,
                H = e.speed ? ? 1,
                I = e.scrollType !== "relative" ? e.loopInfinite ? ? !0 : !1,
                W = e.loop ? I ? O : e.loopCount ? ? 1 : 1,
                R = this.sharedState.player ? .state.totalFrames ? ? 0;
            if (o === "absolute") s = g * i, d = R * L * W / H * i + s;
            else if (this.model.attributes.fixed_position) {
        ...
        destroy(...t) {
            this.unsubscribePlayerReady ? .(), f.prototype.destroy.apply(this, t)
        }
    },
    he = S;
export {
