        ...
        objectDifference: function(C, U) {
            ...
            return P.default.each(U, function(k, z) {
                if (P.default.isObject(k) && !P.default.isArray(k)) {
                    B[z] = P.default.objectDifference(C ? .[z], U[z]), P.default.isEmpty(B[z]) && !P.default.isEmpty(U[z]) ? delete B[z] : B[z] = U[z];
                    return
                }
...
var Bi = On((Hn, ft) => {
    ...
    (function(C, U) {
        ...
        r.fn = r.prototype = {
            ...
            var e, t, n, i, o, u, s = arguments[0] || {},
                f = 1,
                d = arguments.length,
                g = !1;
            for (typeof s == "boolean" && (g = s, s = arguments[f] || {}, f++), typeof s != "object" && !r.isFunction(s) && (s = {}), f === d && (s = this, f--); f < d; f++)
                if ((e = arguments[f]) != null)
                    for (t in e) n = s[t], i = e[t], s !== i && (g && i && (r.isPlainObject(i) || (o = r.isArray(i))) ? (o ? (o = !1, u = n && r.isArray(n) ? n : []) : u = n && r.isPlainObject(n) ? n : {}, s[t] = r.extend(g, u, i)) : i !== void 0 && (s[t] = i));
            return s
        }, r.extend({
            ...
            map: function(e, t, n) {
                var i, o, u = 0,
                    s = [];
                if (ct(e))
                    for (i = e.length; u < i; u++) o = t(e[u], u, n), o != null && s.push(o);
                else
                    for (u in e) o = t(e[u], u, n), o != null && s.push(o);
                return Ge.apply([], s)
            },
            guid: 1,
            proxy: function(e, t) {
        ...
        var je = function(e) {
            var t, n, i, o, u, s, f, d, g, p, b, T, x, R, L, O, ue, J, ye, S = "sizzle" + 1 * new Date,
                K = e.document,
                H = 0,
                G = 0,
                ve = jt(),
            ...
            function $(a, l, c, y) {
                var h, m, v, w, E, q, N, A, M = l && l.ownerDocument,
                    I = l ? l.nodeType : 9;
                ...
                if (!y && ((l ? l.ownerDocument || l : K) !== x && T(l), l = l || x, L)) {
                    ...
                    if (n.qsa && !se[a + " "] && (!O || !O.test(a))) {
                        if (I !== 1) M = l, A = a;
                        else if (l.nodeName.toLowerCase() !== "object") {
            ...
            n = $.support = {}, u = $.isXML = function(a) {
                ...
                var l, c, y = a ? a.ownerDocument || a : K;
                ...
                filter: {
                    ...
                    CHILD: function(a, l, c, y, h) {
                        ...
                        return y === 1 && h === 0 ? function(E) {
                            ...
                            var A, M, I, D, Q, Z, ie = m !== v ? "nextSibling" : "previousSibling",
                                X = E.parentNode,
                            ...
                            if (X) {
                                if (m) {
                                    for (; ie;) {
                                        for (D = E; D = D[ie];)
                                            if (w ? D.nodeName.toLowerCase() === Ue : D.nodeType === 1) return !1;
                                        Z = ie = a === "only" && !Z && "nextSibling"
                                    }
                                    return !0
                                }
                                if (Z = [v ? X.firstChild : X.lastChild], v && Ve) {
                                    for (D = X, I = D[S] || (D[S] = {}), M = I[D.uniqueID] || (I[D.uniqueID] = {}), A = M[a] || [], Q = A[0] === H && A[1], re = Q && A[2], D = Q && X.childNodes[Q]; D = ++Q && D && D[ie] || (re = Q = 0) || Z.pop();)
                                        if (D.nodeType === 1 && ++re && D === E) {
                                            M[a] = [H, Q, re];
                                            break
                                        }
                                } else if (Ve && (D = E, I = D[S] || (D[S] = {}), M = I[D.uniqueID] || (I[D.uniqueID] = {}), A = M[a] || [], Q = A[0] === H && A[1], re = Q), re === !1)
                                    for (;
                                        (D = ++Q && D && D[ie] || (re = Q = 0) || Z.pop()) && !((w ? D.nodeName.toLowerCase() === Ue : D.nodeType === 1) && ++re && (Ve && (I = D[S] || (D[S] = {}), M = I[D.uniqueID] || (I[D.uniqueID] = {}), M[a] = [H, re]), D === E)););
                                return re -= h, re === y || re % y === 0 && re / y >= 0
                            }
                        }
                    },
                    PSEUDO: function(a, l) {
                        var c, y = i.pseudos[a] || i.setFilters[a.toLowerCase()] || $.error("unsupported pseudo: " + a);
                ...
                pseudos: {
                    ...
                    contains: ce(function(a) {
                        return a = a.replace(he, ge),
                            function(l) {
                                return (l.textContent || l.innerText || o(l)).indexOf(a) > -1
                            }
                    }),
                    lang: ce(function(a) {
                        return kn.test(a || "") || $.error("unsupported lang: " + a), a = a.replace(he, ge).toLowerCase(),
                            function(l) {
                                var c;
                                do
                                    if (c = L ? l.lang : l.getAttribute("xml:lang") || l.getAttribute("lang")) return c = c.toLowerCase(), c === a || c.indexOf(a + "-") === 0; while ((l = l.parentNode) && l.nodeType === 1);
                                return !1
                            }
                    }),
                    target: function(a) {
            ...
            function Ot(a, l, c) {
                ...
                return l.first ? function(v, w, E) {
                    for (; v = v[y];)
                        if (v.nodeType === 1 || h) return a(v, w, E)
                } : function(v, w, E) {
                    var q, N, A, M = [H, m];
                    if (E) {
                        for (; v = v[y];)
                            if ((v.nodeType === 1 || h) && a(v, w, E)) return !0
                    } else
                        for (; v = v[y];)
                            if (v.nodeType === 1 || h) {
            ...
            function Pt(a, l, c, y, h, m) {
                return y && !y[S] && (y = Pt(y)), h && !h[S] && (h = Pt(h, m)), ce(function(v, w, E, q) {
                    var N, A, M, I = [],
                        ...
                        X = c ? h || (v ? a : Q || y) ? [] : w : ie;
                    if (c && c(ie, X, E, q), y)
                        for (N = st(X, D), y(N, [], E, q), A = N.length; A--;)(M = N[A]) && (X[D[A]] = !(ie[D[A]] = M));
                    if (v) {
                        if (h || a) {
                            if (h) {
            ...
            function Rt(a) {
                for (var l, c, y, h = a.length, m = i.relative[a[0].type], v = m || i.relative[" "], w = m ? 1 : 0, E = Ot(function(A) {
                    ...
                    if (c = i.relative[a[w].type]) N = [Ot(Ht(N), c)];
                    else {
                ...
                var c = l.length > 0,
                    ...
                    h = function(m, v, w, E, q) {
                        ...
                        for (q && (g = v === x || v || q); D !== Ve && (N = X[D]) != null; D++) {
                            if (y && N) {
                                for (A = 0, !v && N.ownerDocument !== x && (T(N), w = !L); M = a[A++];)
                                    if (M(N, v || x, w)) {
                                        E.push(N);
                                        break
                                    }
            ...
            return f = $.compile = function(a, l) {
                ...
                var h, m, v, w, E, q = typeof a == "function" && a,
                    N = !y && s(a = q.selector || a);
                if (c = c || [], N.length === 1) {
                    if (m = N[0] = N[0].slice(0), m.length > 2 && (v = m[0]).type === "ID" && n.getById && l.nodeType === 9 && L && i.relative[m[1].type]) {
                        if (l = (i.find.ID(v.matches[0].replace(he, ge), l) || [])[0], l) q && (l = l.parentNode);
                        else return c;
                        a = a.slice(m.shift().value.length)
                    }
                    for (h = ot.needsContext.test(a) ? 0 : m.length; h-- && (v = m[h], !i.relative[w = v.type]);)
                        if ((E = i.find[w]) && (y = E(v.matches[0].replace(he, ge), kt.test(m[0].type) && Lt(l.parentNode) || l))) {
            ...
            Fn = r.fn.init = function(e, t, n) {
                ...
                if (n = n || _t, typeof e == "string")
                    if (e[0] === "<" && e[e.length - 1] === ">" && e.length >= 3 ? i = [null, e, null] : i = Mn.exec(e), i && (i[1] || !t))
                        if (i[1]) {
                            if (t = t instanceof r ? t[0] : t, r.merge(this, r.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : k, !0)), Wt.test(i[1]) && r.isPlainObject(t))
                                for (i in t) r.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                            return this
        ...
        r.fn.extend({
            ...
            closest: function(e, t) {
                for (var n, i = 0, o = this.length, u = [], s = It.test(e) || typeof e != "string" ? r(e, t || this.context) : 0; i < o; i++)
                    for (n = this[i]; n && n !== t; n = n.parentNode)
                        if (n.nodeType < 11 && (s ? s.index(n) > -1 : n.nodeType === 1 && r.find.matchesSelector(n, e))) {
                            u.push(n);
                            break
                        }
        ...
        r.Callbacks = function(e) {
            ...
            var t, n, i, o, u = [],
                ...
                f = -1,
                d = function() {
                    for (o = e.once, i = t = !0; s.length; f = -1)
                        for (n = s.shift(); ++f < u.length;) u[f].apply(n[0], n[1]) === !1 && e.stopOnFalse && (f = u.length, n = !1);
                ...
                g = {
                    ...
                    remove: function() {
                        return r.each(arguments, function(p, b) {
                            for (var T;
                                (T = r.inArray(b, u, T)) > -1;) u.splice(T, 1), T <= f && f--
                        }), this
                    },
                    has: function(p) {
            ...
            when: function(e) {
                var t = 0,
                    ...
                    f, d, g;
                if (i > 1)
                    for (f = new Array(i), d = new Array(i), g = new Array(i); t < i; t++) n[t] && r.isFunction(n[t].promise) ? n[t].promise().progress(s(t, d, f)).done(s(t, g, n)).fail(u.reject) : --o;
        ...
        var pe = function(e, t, n, i, o, u, s) {
                ...
                if (r.type(n) === "object") {
                    ...
                    for (; f < d; f++) t(e[f], n, s ? i : i.call(e[f], f, t(e[f], n)));
        ...
        Fe.uid = 1, Fe.prototype = {
            ...
            remove: function(e, t) {
                var n, i, o, u = e[this.expando];
                if (u !== void 0) {
                    if (t === void 0) this.register(e);
                    else
                        for (r.isArray(t) ? i = t.concat(t.map(r.camelCase)) : (o = r.camelCase(t), t in u ? i = [t, o] : (i = o, i = i in u ? [i] : i.match(fe) || [])), n = i.length; n--;) delete u[i[n]];
        ...
        function zt(e, t, n) {
            ...
            if (n === void 0 && e.nodeType === 1)
                if (i = "data-" + t.replace($t, "-$&").toLowerCase(), n = e.getAttribute(i), typeof n == "string") {
                    try {
        ...
        function Yt(e, t, n, i, o) {
            for (var u, s, f, d, g, p, b = t.createDocumentFragment(), T = [], x = 0, R = e.length; x < R; x++)
                if (u = e[x], u || u === 0)
                    if (r.type(u) === "object") r.merge(T, u.nodeType ? [u] : u);
                    else if (!$n.test(u)) T.push(t.createTextNode(u));
            else {
            ...
            for (b.textContent = "", x = 0; u = T[x++];) {
                ...
                if (g = r.contains(u.ownerDocument, u), s = ee(b.appendChild(u), "script"), g && pt(s), n)
                    for (p = 0; u = s[p++];) Qt.test(u.type || "") && n.push(u)
            }
            return b
        }(function() {
        ...
        function ht(e, t, n, i, o, u) {
            ...
            if (i == null && o == null ? (o = n, i = n = void 0) : o == null && (typeof n == "string" ? (o = i, i = void 0) : (o = i, i = n, n = void 0)), o === !1) o = Le;
            else if (!o) return e;
        ...
        r.event = {
            ...
            add: function(e, t, n, i, o) {
                var u, s, f, d, g, p, b, T, x, R, L, O = j.get(e);
                if (O)
                    for (n.handler && (u = n, n = u.handler, o = u.selector), n.guid || (n.guid = r.guid++), (d = O.events) || (d = O.events = {}), (s = O.handle) || (s = O.handle = function(ue) {
            ...
            remove: function(e, t, n, i, o) {
                var u, s, f, d, g, p, b, T, x, R, L, O = j.hasData(e) && j.get(e);
                if (!(!O || !(d = O.events))) {
            ...
            dispatch: function(e) {
                ...
                if (f[0] = e, e.delegateTarget = this, !(g.preDispatch && g.preDispatch.call(this, e) === !1)) {
                    for (s = r.event.handlers.call(this, e, d), t = 0;
                        (o = s[t++]) && !e.isPropagationStopped();)
                        for (e.currentTarget = o.elem, n = 0;
                            (u = o.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e.rnamespace || e.rnamespace.test(u.namespace)) && (e.handleObj = u, e.data = u.data, i = ((r.event.special[u.origType] || {}).handle || u.handler).apply(o.elem, f), i !== void 0 && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
            ...
            handlers: function(e, t) {
                ...
                if (f && d.nodeType && (e.type !== "click" || isNaN(e.button) || e.button < 1)) {
                    for (; d !== this; d = d.parentNode || this)
                        if (d.nodeType === 1 && (d.disabled !== !0 || e.type !== "click")) {
        ...
        function en(e, t) {
            ...
            if (t.nodeType === 1) {
                if (j.hasData(e) && (u = j.access(e), s = j.set(t, u), g = u.events, g)) {
                    ...
                    for (o in g)
                        for (n = 0, i = g[o].length; n < i; n++) r.event.add(t, o, g[o][n])
                }
        ...
        function Ce(e, t, n, i) {
            ...
            if (b && (o = Yt(t, e[0].ownerDocument, !1, e, i), u = o.firstChild, o.childNodes.length === 1 && (o = u), u || i)) {
                ...
                if (f)
                    for (g = s[s.length - 1].ownerDocument, r.map(s, Kn), p = 0; p < f; p++) d = s[p], Qt.test(d.type || "") && !j.access(d, "globalEval") && r.contains(g, d) && (d.src ? r._evalUrl && r._evalUrl(d.src) : r.globalEval(d.textContent.replace(Yn, "")))
            }
            return e
        }

        function tn(e, t, n) {
            for (var i, o = t ? r.filter(t, e) : e, u = 0;
                (i = o[u]) != null; u++) !n && i.nodeType === 1 && r.cleanData(ee(i)), i.parentNode && (n && r.contains(i.ownerDocument, i) && pt(ee(i, "script")), i.parentNode.removeChild(i));
            return e
        }
        r.extend({
            ...
            clone: function(e, t, n) {
                var i, o, u, s, f = e.cloneNode(!0),
                    d = r.contains(e.ownerDocument, e);
                if (!W.noCloneChecked && (e.nodeType === 1 || e.nodeType === 11) && !r.isXMLDoc(e))
                    for (s = ee(f), u = ee(e), i = 0, o = u.length; i < o; i++) Zn(u[i], s[i]);
                if (t)
                    if (n)
                        for (u = u || ee(e), s = s || ee(f), i = 0, o = u.length; i < o; i++) en(u[i], s[i]);
                    else en(e, f);
                return s = ee(f, "script"), s.length > 0 && pt(s, !d && ee(e, "script")), f
            },
            cleanData: function(e) {
                for (var t, n, i, o = r.event.special, u = 0;
                    (n = e[u]) !== void 0; u++)
                    if (Me(n)) {
                        if (t = n[j.expando]) {
                            if (t.events)
            ...
            empty: function() {
                for (var e, t = 0;
                    (e = this[t]) != null; t++) e.nodeType === 1 && (r.cleanData(ee(e, !1)), e.textContent = "");
                return this
            },
            clone: function(e, t) {
        ...
        (function() {
            var e, t, n, i, o = k.createElement("div"),
            ...
            r.extend(W, {
                ...
                reliableMarginRight: function() {
                    var f, d = u.appendChild(k.createElement("div"));
        ...
        function gn(e, t, n) {
            for (var i, o = (le.tweeners[t] || []).concat(le.tweeners["*"]), u = 0, s = o.length; u < s; u++)
                if (i = o[u].call(n, t, e)) return i
        }

        function ri(e, t, n) {
            var i, o, u, s, f, d, g, p, b = this,
                T = {},
                x = e.style,
                R = e.nodeType && We(e),
                L = j.get(e, "fxshow");
            ...
            for (i in t)
                if (o = t[i], ni.exec(o)) {
                    if (delete t[i], u = u || o === "toggle", o === (R ? "hide" : "show"))
                        if (o === "show" && L && L[i] !== void 0) R = !0;
                        else continue;
                    T[i] = L && L[i] || r.style(e, i)
                } else g = void 0;
            if (r.isEmptyObject(T))(g === "none" ? gt(e.nodeName) : g) === "inline" && (x.display = g);
            else {
        ...
        function oi(e, t) {
            var n, i, o, u, s;
            for (n in e)
                if (i = r.camelCase(n), o = t[i], u = e[n], r.isArray(u) && (o = u[1], u = e[n] = u[0]), n !== i && (e[i] = u, delete e[n]), s = r.cssHooks[i], s && "expand" in s) {
        ...
        function le(e, t, n) {
            var i, o, u = 0,
                ...
                p = g.props;
            for (oi(p, g.opts.specialEasing); u < s; u++)
                if (i = le.prefilters[u].call(g, e, p, g.opts), i) return r.isFunction(i.stop) && (r._queueHooks(g.elem, g.opts.queue).stop = r.proxy(i.stop, i)), i;
                ...
                stop: function(e, t, n) {
                    ...
                    return typeof e != "string" && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function() {
                        var o = !0,
                            ...
                            s = r.timers,
                            f = j.get(this);
                        if (u) f[u] && f[u].stop && i(f[u]);
                        else
                            for (u in f) f[u] && f[u].stop && ii.test(u) && i(f[u]);
        ...
        r.fn.extend({
            ...
            removeAttr: function(e, t) {
                var n, i, o = 0,
                    u = t && t.match(fe);
                if (u && e.nodeType === 1)
                    for (; n = u[o++];) i = r.propFix[n] || n, r.expr.match.bool.test(n) && (e[i] = !1), e.removeAttribute(n)
            }
        }), yn = {
            set: function(e, t, n) {
        ...
        r.fn.extend({
            ...
            removeClass: function(e) {
                ...
                if (typeof e == "string" && e) {
                    for (t = e.match(fe) || []; n = this[d++];)
                        if (o = Se(n), i = n.nodeType === 1 && (" " + o + " ").replace(xt, " "), i) {
                            for (s = 0; u = t[s++];)
                                for (; i.indexOf(" " + u + " ") > -1;) i = i.replace(" " + u + " ", " ");
                            f = r.trim(i), o !== f && n.setAttribute("class", f)
                        }
                }
                return this
            ...
            toggleClass: function(e, t) {
                ...
                return typeof t == "boolean" && n === "string" ? t ? this.addClass(e) : this.removeClass(e) : r.isFunction(e) ? this.each(function(i) {
                    ...
                    var i, o, u, s;
                    if (n === "string")
                        for (o = 0, u = r(this), s = e.match(fe) || []; i = s[o++];) u.hasClass(i) ? u.removeClass(i) : u.addClass(i);
                    else(e === void 0 || n === "boolean") && (i = Se(this), i && j.set(this, "__className__", i), this.setAttribute && this.setAttribute("class", i || e === !1 ? "" : j.get(this, "__className__") || ""))
                })
            },
            hasClass: function(e) {
                var t, n, i = 0;
                for (t = " " + e + " "; n = this[i++];)
                    if (n.nodeType === 1 && (" " + Se(n) + " ").replace(xt, " ").indexOf(t) > -1) return !0;
                return !1
            }
        });
        var ai = /\r/g,
        ...
        r.fn.extend({
            val: function(e) {
                ...
                })) : o ? (t = r.valHooks[o.type] || r.valHooks[o.nodeName.toLowerCase()], t && "get" in t && (n = t.get(o, "value")) !== void 0 ? n : (n = o.value, typeof n == "string" ? n.replace(ai, "") : n ? ? "")) : void 0
            }
        }), r.extend({
            valHooks: {
                option: {
                    get: function(e) {
                        ...
                        return t ? ? r.trim(r.text(e)).replace(fi, " ")
                    }
                },
                select: {
                    get: function(e) {
                        for (var t, n, i = e.options, o = e.selectedIndex, u = e.type === "select-one" || o < 0, s = u ? null : [], f = u ? o + 1 : i.length, d = o < 0 ? f : u ? o : 0; d < f; d++)
                            if (n = i[d], (n.selected || d === o) && (W.optDisabled ? !n.disabled : n.getAttribute("disabled") === null) && (!n.parentNode.disabled || !r.nodeName(n.parentNode, "optgroup"))) {
        ...
        r.extend(r.event, {
            trigger: function(e, t, n, i) {
                ...
                if (u = s = n = n || k, !(n.nodeType === 3 || n.nodeType === 8) && !vn.test(T + r.event.triggered) && (T.indexOf(".") > -1 && (x = T.split("."), T = x.shift(), x.sort()), d = T.indexOf(":") < 0 && "on" + T, e = e[r.expando] ? e : new r.Event(T, typeof e == "object" && e), e.isTrigger = i ? 2 : 3, e.namespace = x.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = t == null ? [e] : r.makeArray(t, [e]), p = r.event.special[T] || {}, !(!i && p.trigger && p.trigger.apply(n, t) === !1))) {
                    ...
                    for (o = 0;
                        (u = b[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? f : p.bindType || T, g = (j.get(u, "events") || {})[e.type] && j.get(u, "handle"), g && g.apply(u, t), g = d && u[d], g && g.apply && Me(u) && (e.result = g.apply(u, t), e.result === !1 && e.preventDefault());
        ...
        function Tn(e) {
            return function(t, n) {
                ...
                if (r.isFunction(n))
                    for (; i = u[o++];) i[0] === "+" ? (i = i.slice(1) || "*", (e[i] = e[i] || []).unshift(n)) : (e[i] = e[i] || []).push(n)
            }
        }
        ...
        function yi(e, t, n, i) {
            var o, u, s, f, d, g = {},
                p = e.dataTypes.slice();
            if (p[1])
                for (s in e.converters) g[s.toLowerCase()] = e.converters[s];
            for (u = p.shift(); u;)
                if (e.responseFields[u] && (n[e.responseFields[u]] = t), !d && i && e.dataFilter && (t = e.dataFilter(t, e.dataType)), d = u, u = p.shift(), u) {
                    if (u === "*") u = d;
                    else if (d !== "*" && d !== u) {
                        if (s = g[d + " " + u] || g["* " + u], !s) {
                            for (o in g)
                                if (f = o.split(" "), f[1] === u && (s = g[d + " " + f[0]] || g["* " + f[0]], s)) {
        ...
        r.extend({
            ...
            ajax: function(e, t) {
                ...
                var n, i, o, u, s, f, d, g, p = r.ajaxSetup({}, t),
                    b = p.context || p,
                    ...
                    S = {
                        ...
                        getResponseHeader: function(H) {
                            ...
                            if (J === 2) {
                                if (!u)
                                    for (u = {}; G = ci.exec(o);) u[G[1].toLowerCase()] = G[2];
                                G = u[H.toLowerCase()]
                            }
                            return G ? ? null
                        },
                        ...
                        statusCode: function(H) {
                            ...
                            if (H)
                                if (J < 2)
                                    for (G in H) L[G] = [L[G], H[G]];
                                else S.always(H[S.status]);
                            return this
                        },
                        abort: function(H) {
                            var G = H || ye;
                ...
                if (n = wn(wt, p, t, S), !n) K(-1, "No Transport");
                else {
        ...
        r.param = function(e, t) {
            var n, i = [],
                o = function(u, s) {
                    s = r.isFunction(s) ? s() : s ? ? "", i[i.length] = encodeURIComponent(u) + "=" + encodeURIComponent(s)
                };
...
`)
        ...
        r.ajaxSetup({
            ...
            var i, o, u, s = e.jsonp !== !1 && (Nt.test(e.url) ? "url" : typeof e.data == "string" && (e.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && Nt.test(e.data) && "data");
        ...
        r.offset = {
            setOffset: function(e, t, n) {
                var i, o, u, s, f, d, g, p = r.css(e, "position"),
                    b = r(e),
                    T = {};
