...
function b(t, e, n = {}) {
    ...
    let o = e.emptyTitle ? "" : e.title,
        ...
        r = "",
        l = "";
    n.customDomain ? n.forProject ? r = o || "Project" : r = (o ? o + " \u2014 " : "") + (i || "Page " + t.num) : (n.forProject || (r = (i ? "\u2018" + i + "\u2019" : "Page " + t.num) + " from "), r += r.length ? `\u2018${o||"Project"}\u2019` : o || "Project", n.forProject && e.description && (r += " | Readymag")), n.forProject ? l = P(e.pages.find($ => $.num === 1)) : l = P(t);
    let s = "";
...
function x(t, e, n = {}) {
    ...
    let o = e.emptyTitle ? "" : e.title,
        i = "",
        c = "";
    return n.customDomain ? t && t.num > 1 ? i = (o ? o + " \u2014 " : "") + (t.title || "Page " + t.num) : (i = o || "Project", c = e.description || "") : (t && t.num > 1 ? i = (t.title ? "\u2018" + t.title + "\u2019" : "Page " + t.num) + " from " : c = e.description || j, i = o || "Project"), {
        title: i || "",
        description: c || "",
        keywords: ""
    }
...
var j, m, L, D = R(() => {
    ...
    C();
    v();
    j = "Built with Readymag\u2014a tool to design anything on the web.", m = 116;
    L = {
        getPageScreenshot: P,
        getDefaultShare: b,
        getFinalShare: g,
