    ...
    e = class e {
        ...
        static async checkFormatSupport(a) {
            ...
            let s = {
                ...
                webpLossless: "data:image/webp;base64,UklGRhoAAABXRUJQVlA4TA0AAAAvAAAAEAcQERGIiP4HAA==",
                webpAlpha: "data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAARBxAR/Q9ERP8DAABWUDggGAAAABQBAJ0BKgEAAQAAAP4AAA3AAP7mtQAAAA==",
                webpAnimation: "data:image/webp;base64,UklGRlIAAABXRUJQVlA4WAoAAAASAAAAAAAAAAAAQU5JTQYAAAD/////AABBTk1GJgAAAAAAAAAAAAAAAAAAAGQAAABWUDhMDQAAAC8AAAAQBxAREYiI/gcA",
            ...
            switch (a.toLowerCase()) {
                case "webp":
                    {
                        let A = [];A.push(e.loadImage(s.webpLossy)),
                        A.push(e.loadImage(s.webpLossless)),
                        A.push(e.loadImage(s.webpAlpha)),
                        A.push(e.loadImage(s.webpAnimation));
