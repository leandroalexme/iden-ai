    ...
    #cart-sidebar.cart-is-mobile .sidebar-body .cart-item-block {
      background-color: ${n};
        ...
        getAdditionalColor(e) {
            return F(e) < .05 && x("#fff", e) - x("#000", e) >= 8 ? R(.1, e) : _(.1, e)
        },
        ...
        renderCartItem(e, t = "price") {
            ...
            a.data(`${t}-id`, r);
            let c;
            if (e.selectedCombination ? .thumbnailUrl || e.image || e.images && e.images.length) {
        ...
        getProductImage(e) {
            return e.selectedCombination ? .thumbnailUrl ? e.selectedCombination.thumbnailUrl : e.image ? e.image : e.images ? e.images[0] : ""
        },
        getTranslatedOptions(e) {
            ...
            return Object.keys(e.selectedOptions).forEach(r => {
                ...
                if (n ? .nameTranslated && n ? .nameTranslated[c] && (s = f.capitalize(n.nameTranslated[c])), n ? .choices) {
                    let o = n.choices.find(l => l.text === e.selectedOptions[r]);
                    o ? .textTranslated && o ? .textTranslated[c] && (a = o.textTranslated[c])
                }
                let d = (0, i.default)("<div/>", {
        ...
        getOneItemPrice(e) {
            let t = e.price;
            return e.selectedCombination ? .price && (t = e.selectedCombination.price), e.selectedOptions && Object.keys(e.selectedOptions).forEach(r => {
                let s = e.options.find(c => c.name === r),
                    a = s ? s.choices ? .find(c => c.text === e.selectedOptions[r]) : null;
        ...
        async goToCheckout(e) {
            ...
            let s = Object.keys(t.prices),
                a = [],
                c = n => a.push(n);
            await new Promise(n => r.Cart.clear(n)), await new Promise(n => r.Cart.calculateTotal(n)), s.forEach(n => {
                let d = {
                    ...
                    callback: async o => {
                        ...
                        }), r.Cart.gotoCheckout(), h.trigger("ecwid:checkout:opened"), this.mag.eCommerceManager.loadProducts().then(() => {
                ...
                t.prices[n].selectedOptions ? d.options = { ...t.prices[n].selectedOptions
        ...
        getSidebarTextValue(e) {
            ...
            return this.cartWidgetData && this.cartWidgetData[t] ? O.sanitize(this.cartWidgetData[t]) : m.defaultSidebarTexts[e] ? m.defaultSidebarTexts[e] : null
        },
        calcTextFieldSize(e) {
            if (!e) return null;
