...
var f = n.extend({
        ...
        render: function() {
            ...
            return this.makeBox("widget-button"), this.hasHoverAnimation && this.$el.addClass("has-onhover-animation"), this.rendered = !0, this.seamlessFontsShow(function() {
                ...
                block: null
            }, arguments ? .[0] ? .withoutHoverCursor && (t.withoutHoverCursor = !0), this.buttonWidget = new d(t), this.preloadIconImage({
                hover: !0
        ...
        renderButtonTextWithSizes: function(t, e) {
            this.buttonWidget.renderButtonTextWithSizes(t, { ...this,
                ...e
            })
        },
