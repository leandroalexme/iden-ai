...
var it = c.extend({
        ...
        render: function() {
            ...
            return this.$el.find("a").each(function() {
                ...
                } else if (/^__rm_goback$/i.test(e.attr("href"))) e.attr("href", "javascript:void(0)").addClass("goback-link");
                else if (o.mailchimpMatcher.test(e.attr("href"))) {
                ...
                RM.screenshot ||
                    import ("https://st-p.rmcdn1.net/ae5fa58f/dist/c/c-5IPTF35A.js").then(({
                        default: h
                    }) => {
                        h.createPlayer(d)
                    })
