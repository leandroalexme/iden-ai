...
var P = m((Te, te) => {
    ...
    c.rgb.ansi16 = function(e, t = null) {
        let [r, n, s] = e, a = t === null ? c.rgb.hsv(e)[2] : t;
...
var ne = m((Ke, re) => {
    ...
    function Fe(e, t) {
        let r = [t[e].parent, e],
            n = C[t[e].parent][e],
            s = t[e].parent;
        for (; t[s].parent;) r.unshift(t[s].parent), n = Me(C[t[s].parent][s], n), s = t[s].parent;
...
var oe = m((Re, se) => {
    ...
    function Oe(e) {
        let t = function(...r) {
            ...
            let s = e(r);
            if (typeof s == "object")
                for (let a = s.length, o = 0; o < a; o++) s[o] = Math.round(s[o]);
            return s
        };
        return "conversion" in e && (t.conversion = e.conversion), t
    }
...
var ie = m((Le, le) => {
    ...
    function b(e, t) {
        ...
        else if (e instanceof b) this.model = e.model, this.color = [...e.color], this.valpha = e.valpha;
        ...
        if (I[this.model])
            for (n = y[this.model].channels, r = 0; r < n; r++) {
    ...
    b.prototype = {
        ...
        round(e) {
            return e = Math.max(e || 0, 0), new b([...this.color.map(ze(e)), this.valpha], this.model)
        },
        alpha(e) {
    ...
    for (let e of Object.keys(y)) {
        ...
        b.prototype[e] = function(...r) {
            return this.model === e ? new b(this) : r.length > 0 ? new b(r, e) : new b([...Ce(y[this.model][e].raw(this.color)), this.valpha], e)
        }, b[e] = function(...r) {
            let n = r[0];
...
function lt(e) {
    return typeof e == "number" && (e = String(e)), be(He(e))
}
var v, ge, x, We, Ne, He, K, Be, Ge, Qe, Xe, Ye, Ze, Ee, et, tt, rt, nt, st, Pe = de(() => {
    "use strict";
    v = R(ie()), ge = R(fe());
    pe();
    x = e => {
        ...
        return `${(0,v.default)({h:e.h,s:e.s,v:e.v}).hex().replace("#","")}${t}`
    }, Qe = e => {
        let t = x(parseInt((e.a * 255).toFixed(0)));
        return `${(0,v.default)({h:e.h,s:e.s,v:e.v}).hex()}${t}`
    }, Xe = e => {
        try {
            let t = e.replace("#", ""),
...
export {
    ie as a, fe as b, x as c, We as d, Ne as e, He as f, K as g, Be as h, Ge as i, Qe as j, Xe as k, Ye as l, Ze as m, Ee as n, et as o, tt as p, rt as q, nt as r, st as s, ot as t, be as u, at as v, lt as w, Pe as x
};