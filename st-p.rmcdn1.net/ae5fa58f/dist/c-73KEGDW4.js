...
`)
            ...
            var f = function() {
                ...
                return n.prototype.write = function() {
                    ...
                    for (var e = void 0, l = void 0, T = void 0, _ = [];
                        (e = this.parser.readToken()) && !(l = c.isScript(e)) && !(T = c.isStyle(e));) e = this.options.beforeWriteToken(e), e && _.push(e);
                    ...
                    var u = {
                        ...
                        f = function() {
                            ...
                            return r.prototype.append = function(e) {
                                ...
                                for (var l = void 0; l = this.readToken();)
                                    if (e[l.type] && e[l.type](l) === !1) return
                        ...
                        E = o.TagToken = function() {
                            ...
                            return i.formatTag = function(f) {
                                var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null,
                                    r = "<" + f.tagName;
                                for (var t in f.attrs)
                                    if (f.attrs.hasOwnProperty(t)) {
                                        r += " " + t;
                                        var e = f.attrs[t];
